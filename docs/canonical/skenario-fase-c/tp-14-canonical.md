# TP-14 — READING: INSTRUCTIONS AND STEPS
...
| Jenis | Kompleks |
| Tema | Membaca Dunia |
| Total layar | 13 (termasuk Layar 0) |
| Text-anchor | "First, get the oranges. Then cut them in half. Next, squeeze the oranges into a glass. After that, add sugar. Finally, stir and enjoy." |
| Connector aktif | then (fokus produksi — exposure sejak TP-05) · when (fokus produksi — exposure sejak TP-10); then dominan; when muncul satu kali sebagai opsi di model guru |
| Recycle Fase B | I usually... / first, then, after that (TP-06 Fase B) · When it..., I... (TP-10 Fase B) |
| Mode kluster | Membaca & Memirsa dominan · Menyimak sebagai entry point · Menulis sebagai respons teks |
...
| Layar | Judul | Tujuan |
|-------|-------|--------|
| 0 | Pre-Opening · Kelas Siap | Guru menenangkan kelas dan membuka sesi dalam Bahasa Inggris. |
| 1 | Pembuka · Reactivation Kluster D | Guru menjembatani membaca pengumuman TP-13 ke teks prosedur. |
| 2 | Pembuka · Perkenalan Context dan Text-anchor | Guru memperkenalkan prosedur lima langkah membuat jus jeruk. |
| 3 | Inti · INPUT · Membaca Prosedur Bersama | Guru memandu siswa menemukan lima langkah dari teks. |
| 4 | Inti · Model Guru then Dominan when Sekali | Guru memodelkan then sebagai penghubung langkah dan when sebagai opsi. |
| 5 | Inti · Latihan Oral Chained Steps | Guru melatih siswa merangkai langkah dengan then. |
| 6 | Inti · Speed Drill then | Guru melatih then di awal kalimat instruksi. |
| 7 | Inti · INTERACT · Shuffled Images Rekonstruksi Urutan | Guru memandu siswa menyusun urutan lewat deskripsi gambar. |
| 8 | Inti · Verifikasi Sequence Sheet vs Teks | Guru memandu siswa mencocokkan urutan dengan teks. |
| 9 | Inti · OUTPUT · Tulis Langkah-Langkahnya | Guru memandu siswa menulis langkah dengan kalimat sendiri. |
| 10 | Inti · Check and Extend | Guru memandu siswa memeriksa urutan dan menambah kalimat. |
| 11 | Penutup · Share Satu Langkah | Guru memandu siswa membagikan satu langkah ke semua siswa. |
| 12 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-15. |
...
Catatan Penting: Teks prosedur sudah tertulis di papan tulis sebelum siswa masuk.

Darurat: —

---

## LAYAR 1 — PEMBUKA · REACTIVATION KLUSTER D

AKSI: Berdiri di depan kelas tanpa menunjukkan teks baru.
...
Catatan Penting: Reactivation di layar ini berasal dari tulisan siswa sendiri di TP-13, bukan dari text-anchor baru. Satu respons cukup.

Darurat: —

---

## LAYAR 2 — PEMBUKA · PERKENALAN CONTEXT DAN TEXT-ANCHOR

AKSI: Tunjuk teks prosedur di papan tulis.
...
Catatan Penting: Di layar ini siswa hanya mendengarkan dan membaca. Teks diserap utuh dulu sebelum diekstraksi per langkah.

Darurat: —

---

## LAYAR 3 — INTI · INPUT · MEMBACA PROSEDUR BERSAMA
...
Catatan Penting: Setiap jawaban ditemukan dari teks, bukan dari ingatan.

Darurat: —

---

## LAYAR 4 — INTI · MODEL GURU THEN DOMINAN WHEN SEKALI

AKSI: Berdiri di depan kelas tanpa melihat papan tulis.
...
Catatan Penting: then muncul empat kali, satu per transisi. when muncul satu kali sebagai opsi, bukan alternatif setara. Jangan tambahkan contoh when kedua.

Darurat: —

---

## LAYAR 5 — INTI · LATIHAN ORAL CHAINED STEPS

AKSI: Tutup atau sembunyikan teks prosedur di papan tulis sementara.
...
Catatan Penting: Siswa harus bisa mendeskripsikan setiap langkah secara verbal sebelum mendeskripsikan gambar ke pasangan di Layar 7.

Darurat: —

---

## LAYAR 6 — INTI · SPEED DRILL THEN

AKSI: Tampilkan kembali teks prosedur di papan tulis.
...
Catatan Penting: Layar ini FLEX — lewati jika kelas sudah lancar menggunakan then di Layar 4 dan Layar 5. Cepat, tidak lebih dari tiga menit.

Darurat: —

---

## LAYAR 7 — INTI · INTERACT · SHUFFLED IMAGES REKONSTRUKSI URUTAN

AKSI: Bagikan Image Cards Set A ke setengah siswa dan Set B ke setengah siswa lainnya secara bergantian.
...
Catatan Penting: Image Cards tidak diperlihatkan ke pasangan, dideskripsikan secara verbal. Urutan Set A dan Set B sengaja berbeda.
...
## LAYAR 8 — INTI · VERIFIKASI SEQUENCE SHEET VS TEKS

AKSI: Tampilkan kembali teks prosedur di papan tulis jika sudah disembunyikan.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 10 menit sebelum OUTPUT. Teks adalah alat verifikasi, bukan jawaban yang disalin.

Darurat: —

---

## LAYAR 9 — INTI · OUTPUT · TULIS LANGKAH-LANGKAHNYA

AKSI: Biarkan teks prosedur tetap tampil di papan tulis.
...
Catatan Penting: Teks prosedur tetap tampil selama OUTPUT. Output adalah parafrase, bukan salinan verbatim. Perbedaan kecil dalam diksi sudah cukup bukti produksi mandiri.
...
## LAYAR 10 — INTI · CHECK AND EXTEND

AKSI: Setelah delapan menit, beri sinyal tanpa menghentikan siswa yang masih menulis.
UCAP: "Two more minutes. Read your steps. Is the order correct? Did you use then?"

AKSI: Untuk siswa yang butuh bantuan, dekati, tunjuk Sequence Sheet siswa, ucapkan "Write this step. Then, the action.".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat dengan when, "When the juice is ready, you can drink it.".
...
Catatan Penting: Connector when yang muncul spontan diterima, tetapi tidak dipaksakan. Fokus produksi adalah then.

Darurat: —

---

## LAYAR 11 — PENUTUP · SHARE SATU LANGKAH

AKSI: Tanyakan siapa yang mau membacakan satu kalimat dari tulisannya.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "Then or when?" memfokuskan perhatian pada connector dari kalimat nyata.

Darurat: —

---

## LAYAR 12 — PENUTUP · CLOSURE
...
Catatan Penting: "And you put the steps back in the right order." merangkum pencapaian TP-14, rekonstruksi logis dari informasi yang tidak berurutan.
