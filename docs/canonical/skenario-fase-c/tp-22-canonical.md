...
| Jenis | Capstone |
| Tema | Capstone |
| Total layar | 16 (termasuk Layar 0) |
| Text-anchor | — |
| Connector aktif | semua connector TP-01 sampai TP-20 tersedia; because paling natural; tidak ada connector baru |
| Recycle Fase B | semua pola TP-01 sampai TP-20 tersedia; pola yang muncul ditentukan pilihan topik siswa, bukan instruksi guru |
| Mode kluster | — |
...
| Layar | Judul | Tujuan |
|-------|-------|--------|
| 0 | Pre-Opening · Kelas Siap | Guru menenangkan kelas dan membuka sesi terakhir. |
| 1 | Pembuka · Reactivation Tulisan TP-21 | Guru menjembatani membaca teks dunia nyata ke memproduksi teks sendiri. |
| 2 | Pembuka · My World Project | Guru memperkenalkan proyek dan empat jenis teks. |
| 3 | Inti · INPUT · Orientasi Empat Jenis Teks | Guru memberi label empat jenis teks. |
| 4 | Inti · Demo Guru Poster Mini Warung Pak Hendra | Guru memodelkan proyek lengkap secara lisan. |
| 5 | Inti · Rubrik Empat Kriteria | Guru menjelaskan empat kriteria proyek. |
| 6 | Inti · INTERACT · Choice Card Rencanakan Proyekmu | Guru memandu siswa merencanakan proyek di Choice Card. |
| 7 | Inti · Share Choice Card dengan Pasangan | Guru memandu siswa berbagi dan bertanya rencana proyek. |
| 8 | Inti · Micro-output Kalimat Pertama Lisan | Guru memandu siswa melafalkan kalimat pertama. |
| 9 | Inti · OUTPUT · Produksi Teks | Guru memandu siswa menulis teks proyek. |
| 10 | Inti · Produksi Visual | Guru memandu siswa membuat visual proyek. |
| 11 | Inti · Circulate dan Rubrik Check | Guru memandu siswa memeriksa proyek dengan rubrik. |
| 12 | Penutup · Sampling Lisan | Guru mendekati siswa individual menanyakan proyek. |
| 13 | Penutup · Gallery Walk | Guru memandu siswa membaca proyek teman. |
| 14 | Penutup · Share Satu Kalimat | Guru memandu siswa membagikan satu kalimat ke semua siswa. |
| 15 | Penutup · Closure | Guru menutup sesi dan menutup Fase C. |

---

## LAYAR 0 — PRE-OPENING · KELAS SIAP
...
Catatan Penting: Papan kiri sudah bertuliskan empat jenis teks sebelum siswa masuk. Choice Card belum dibagikan.

Darurat: —

---

## LAYAR 1 — PEMBUKA · REACTIVATION TULISAN TP-21

AKSI: Berdiri di depan kelas tanpa menunjukkan teks.
...
Catatan Penting: Reactivation di layar ini berasal dari tulisan siswa sendiri di TP-21, bukan dari text-anchor baru. Satu kalimat cukup.

Darurat: —

---

## LAYAR 2 — PEMBUKA · MY WORLD PROJECT

UCAP: "This is My World Project."
...
Catatan Penting: Layar ini FLEX — lewati jika kelas sudah responsif di Layar 1 dan waktu tersisa kurang dari 55 menit.

Darurat: —

---

## LAYAR 3 — INTI · INPUT · ORIENTASI EMPAT JENIS TEKS
...
Catatan Penting: Empat jenis teks diperkenalkan minimal, satu kalimat per tipe. Tidak ada drill, tidak ada pertanyaan kelas.

Darurat: —

---

## LAYAR 4 — INTI · DEMO GURU POSTER MINI WARUNG PAK HENDRA

AKSI: Ambil poster mini warung Pak Hendra yang sudah disiapkan.
...
Catatan Penting: Demo ini satu-satunya model sebelum produksi. Setelah poster diletakkan menjauh, poster tidak ditampilkan lagi.

Darurat: —

---

## LAYAR 5 — INTI · RUBRIK EMPAT KRITERIA

AKSI: Tulis empat kriteria di pojok papan tulis sebagai empat baris terpisah: "1. Text: is there a communicative text? 2. Content: is it about your own topic? 3. Visual: does the image support the text? 4. Oral: can you explain your project in 2-3 sentences?".
...
Catatan Penting: Rubrik empat baris dibiarkan di pojok papan tulis sampai akhir sesi. Kriteria keempat disampaikan sebelum produksi dimulai.

Darurat: —

---

## LAYAR 6 — INTI · INTERACT · CHOICE CARD RENCANAKAN PROYEKMU

AKSI: Bagikan Choice Card, satu per siswa.
...
Catatan Penting: "Choose something you know well." adalah instruksi terpenting. Topik unik adalah nilai, bukan kesalahan.

Darurat: —

---

## LAYAR 7 — INTI · SHARE CHOICE CARD DENGAN PASANGAN
...
Catatan Penting: Setiap siswa mengajukan pertanyaan yang hanya bisa ditanyakan setelah mendengar keempat elemen pasangan.
...
## LAYAR 8 — INTI · MICRO-OUTPUT KALIMAT PERTAMA LISAN

UCAP: "Before we write, say your first sentence. To your partner. Now."
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit sebelum Breakpoint atau kelas sudah antusias. Tidak ada umpan balik grammar di sini.
...
**Titik henti aman setelah Layar 8. Jika waktu tidak cukup, hentikan sesi di sini; sesi berikutnya mulai dari Layar 9.**

UCAP: "Stop here. Save your project."
UCAP: "Next time we finish your project."
AKSI: Minta siswa menyimpan Choice Card dan catatan mereka.
AKSI: Di awal sesi kedua, minta siswa membaca kembali Choice Card mereka, lalu lanjut ke Layar 9.

Catatan Penting: Sesi kedua mulai dari produksi teks. Choice Card disimpan sebagai fondasi.

---

## LAYAR 9 — INTI · OUTPUT · PRODUKSI TEKS
...
Catatan Penting: Tidak ada kalimat model di papan tulis. Kalimat dari tulisan siswa sendiri di TP-17, TP-18, TP-19 adalah model paling kuat.
...
Catatan Penting: Visual valid jika orang bisa menebak topik dari gambar tanpa membaca teks. Kualitas artistik tidak dinilai, hanya relevansi.
...
## LAYAR 11 — INTI · CIRCULATE DAN RUBRIK CHECK

UCAP: "Look at the rubric. Check your own work."
...
AKSI: Untuk siswa yang butuh bantuan, tunjuk kalimat terakhir siswa, bisikkan "What do you think about this topic? Write, I think, then because.", lalu tinggalkan.
AKSI: Untuk siswa yang sudah bisa, bisikkan "Can you add one more sentence, something personal? What does this topic mean to you?", lalu tinggalkan.
AKSI: Buka overlay penilaian formatif.

BANTUAN: Jika siswa yang teksnya banyak tapi visual belum ada: bisikkan "Quick drawing, just one thing.".

Catatan Penting: Teks tiga kalimat yang koheren sudah valid. Jangan mendorong penambahan kalimat hanya untuk menambah volume.

Darurat: —

---

## LAYAR 12 — PENUTUP · SAMPLING LISAN

UCAP: "Now, I will come to you."
AKSI: Jeda 1 detik.
...
Catatan Penting: Guru mendekati siswa individual, tidak memanggil ke depan. Ketidakmampuan menjelaskan adalah data untuk guru, bukan momen koreksi publik.
...
## LAYAR 13 — PENUTUP · GALLERY WALK

AKSI: Minta siswa menaruh proyek di meja masing-masing dengan teks dan visual menghadap ke atas.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 8 menit. Gallery walk bukan kompetisi, guru tidak memilih proyek terbaik.

Darurat: —

---

## LAYAR 14 — PENUTUP · SHARE SATU KALIMAT

AKSI: Tanyakan siapa yang mau membacakan satu kalimat dari proyeknya.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Jenis teks bisa tumpang tindih, tidak ada jawaban benar atau salah.

Darurat: —

---

## LAYAR 15 — PENUTUP · CLOSURE
...
Catatan Penting: Lima kalimat closure diucapkan dengan tenang dan lambat. Jeda di antara setiap kalimat adalah bagian dari penutupan Fase C.
