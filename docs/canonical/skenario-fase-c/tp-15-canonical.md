...
| Text-anchor | "Last Sunday, Budi went to the market. He bought vegetables." |
| Connector aktif | then · and — tersedia untuk produksi bebas dalam narasi; tidak ada connector baru |
| Recycle Fase B | Yesterday I... / Last week I... (TP-05 Fase B) · He has... / She has... (TP-02 Fase B) · They live / They eat (TP-09 Fase B) |
...
| 1 | Pembuka · Reactivation Kluster D | Guru menjembatani membaca prosedur TP-14 ke cerita. |
| 2 | Pembuka · Perkenalan Text-anchor Awal Cerita | Guru memperkenalkan awal cerita dan membuka rasa ingin tahu. |
| 3 | Inti · INPUT · Story Cards Baca Setengah Cerita | Guru memandu siswa membaca separuh cerita dari kartu. |
| 4 | Inti · Past Tense Satu Noticing | Guru menandai dua kata bentuk lampau dari cerita. |
| 5 | Inti · Latihan Ceritakan Kartumu | Guru melatih siswa menceritakan kartu sendiri secara lisan. |
| 6 | Inti · Chain Practice Estafet Cerita | Guru memandu estafet kalimat per kelompok kartu. |
| 7 | Inti · INTERACT · Info Gap A Punya Awal B Punya Akhir | Guru memandu siswa bertukar cerita lewat berbicara. |
| 8 | Inti · Story Check Seberapa Lengkap | Guru memandu siswa membandingkan cerita dengan teks lengkap. |
| 9 | Inti · OUTPUT · Tulis Cerita Lengkap | Guru memandu siswa menulis cerita lengkap dengan kalimat sendiri. |
| 10 | Inti · Check and Extend | Guru memandu siswa memeriksa awal dan akhir cerita. |
| 11 | Penutup · Share Satu Kalimat | Guru memandu siswa membagikan satu kalimat cerita. |
| 12 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-16. |
...
Catatan Penting: Text-anchor sudah tertulis di papan tulis sebelum siswa masuk.
...
Catatan Penting: Reactivation di layar ini berasal dari tulisan siswa sendiri di TP-14, bukan dari text-anchor baru. Satu respons cukup.

Darurat: —

---

## LAYAR 2 — PEMBUKA · PERKENALAN TEXT-ANCHOR AWAL CERITA
...
Catatan Penting: "What happened next?" sengaja tidak dijawab di layar ini. Rasa ingin tahu ini mendorong INTERACT di Layar 7.

Darurat: —

---

## LAYAR 3 — INTI · INPUT · STORY CARDS BACA SETENGAH CERITA

AKSI: Bagikan Story Card A ke setengah siswa dan Story Card B ke setengah siswa lainnya secara bergantian.
...
Catatan Penting: Siswa A hanya tahu kalimat 1 sampai 3, siswa B hanya tahu kalimat 4 sampai 6. Konten kartu yang bukan milik siswa tidak dibacakan di layar ini.

Darurat: —

---

## LAYAR 4 — INTI · PAST TENSE SATU NOTICING

AKSI: Tunjuk kata "went" di text-anchor.
...
## LAYAR 5 — INTI · LATIHAN CERITAKAN KARTUMU
...
Catatan Penting: Latihan ini mempersiapkan siswa menceritakan kartu tanpa menunjukkannya di Layar 7.

Darurat: —

---

## LAYAR 6 — INTI · CHAIN PRACTICE ESTAFET CERITA

AKSI: Tunjuk tiga siswa yang memegang Card A satu per satu.
...
Catatan Penting: Layar ini FLEX — lewati jika kelas sudah lancar menceritakan kartu di Layar 5. Setiap kelompok hanya menceritakan kartunya sendiri.

Darurat: —

---

## LAYAR 7 — INTI · INTERACT · INFO GAP A PUNYA AWAL B PUNYA AKHIR
...
Catatan Penting: Story Card tidak diperlihatkan ke pasangan. Informasi hanya berpindah lewat bahasa lisan.
...
## LAYAR 8 — INTI · STORY CHECK SEBERAPA LENGKAP

AKSI: Tampilkan teks cerita lengkap enam kalimat di papan tulis.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 10 menit sebelum OUTPUT. Verifikasi ini tentang kelengkapan, bukan benar atau salah.

Darurat: —

---

## LAYAR 9 — INTI · OUTPUT · TULIS CERITA LENGKAP

AKSI: Biarkan teks cerita lengkap tetap tampil di papan tulis.
...
Catatan Penting: Teks cerita lengkap tetap tampil selama OUTPUT. Yang dilarang menyalin enam kalimat persis, yang diinginkan narasi sama dalam kalimat sendiri.
...
AKSI: Untuk siswa yang butuh bantuan, dekati, tunjuk kalimat terakhir cerita di papan tulis, tanyakan "Did you write the ending? Add this.".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat opini atau reaksi personal, "I like this story because it is about helping each other.".
...
Catatan Penting: Diferensiasi sudah bisa mendorong respons personal terhadap cerita, pendapat yang berbeda-beda per siswa.

Darurat: —

---

## LAYAR 11 — PENUTUP · SHARE SATU KALIMAT

AKSI: Tanyakan siapa yang mau membacakan satu kalimat dari cerita mereka.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "Beginning or end?" menjaga kelas terhubung dengan struktur cerita.
...
Catatan Penting: "You read half. Your partner told you the rest." merangkum pencapaian TP-15, rekonstruksi narasi melalui komunikasi.
