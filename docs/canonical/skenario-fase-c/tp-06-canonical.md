...
| Text-anchor | "I like playing football because it is fun. I always play with my friends." |
| Connector aktif | because — exposure only; fokus produksi di TP-07 dan TP-17 |
| Recycle Fase B | I like... / I like... because... (TP-13 Fase B) · I usually... / always (TP-06 Fase B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Rutinitas TP-05 | Guru mengaktifkan kembali pola rutinitas dari TP-05. |
| 2 | Pembuka · Perkenalan Text-Anchor dan Framing Inklusif | Guru memperkenalkan text-anchor dan pilihan hobi bebas. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan hobi dan memajankan connector because. |
| 4 | Inti · My Hobby Card | Guru memandu siswa mengisi kartu hobi sendiri. |
| 5 | Inti · Drill Cepat What's Your Hobby | Guru melatih pola I like dan alasan. |
| 6 | Inti · INTERACT · Hobby Exchange Table | Guru memandu siswa mengisi tabel pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Hobi Paling Unik | Guru memandu siswa membandingkan hobi. |
| 8 | Inti · OUTPUT · Write About My Hobby | Guru memandu siswa menulis hobi sendiri. |
...
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-07. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION RUTINITAS TP-05
...
Catatan Penting: Reactivation di layar ini berasal dari tulisan siswa sendiri di TP-05, bukan dari text-anchor baru.

Darurat: —

---

## LAYAR 2 — PEMBUKA · PERKENALAN TEXT-ANCHOR DAN FRAMING INKLUSIF
...
Catatan Penting: Framing inklusif hadir sebelum siswa mengisi kartu. Hobi apa pun valid, bukan hanya olahraga.
...
Catatan Penting: Connector "because" muncul dua kali di model guru, exposure only. Jangan sebut kata itu secara terpisah atau beri komentar tentang fungsinya.

Darurat: —

---

## LAYAR 4 — INTI · MY HOBBY CARD

AKSI: Bagikan My Hobby Card, satu per siswa.
...
Catatan Penting: Setiap siswa mengisi minimal bagian "I like ___" sebelum Layar 6. Bagian "because ___" boleh dilengkapi saat Layar 6.

Darurat: Jika ada siswa belum mengisi apa pun setelah tiga menit → dekati, tunjuk bagian "I like ___", bantu isi satu kata.

---

## LAYAR 5 — INTI · DRILL CEPAT WHAT'S YOUR HOBBY
...
## LAYAR 6 — INTI · INTERACT · HOBBY EXCHANGE TABLE

AKSI: Bagikan Hobby Exchange Table, satu per siswa, kolom My Partner's Hobby kosong.
...
AKSI: Minta siswa A bertanya ke siswa B lalu mengisi kolom My Partner's Hobby.
AKSI: Minta siswa B bertanya ke siswa A lalu mengisi kolom My Partner's Hobby.
...
Catatan Penting: Kolom My Hobby terisi sebelum pair work dimulai. Kolom My Partner's Hobby dibagikan dalam keadaan kosong.
...
## LAYAR 7 — INTI · MINI-SHARE HOBI PALING UNIK
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Hobi yang tidak biasa dihargai setara dengan hobi umum.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE ABOUT MY HOBBY
...
Catatan Penting: Text-anchor sudah diturunkan sebelum layar ini. Bentuk "because" yang tidak sempurna diterima tanpa koreksi.
...
AKSI: Untuk siswa yang butuh bantuan, dekati dan ucapkan panduan konkret, "You wrote what you like. Can you write when you do it? I always read at night.".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat dengan because untuk alasan berbeda, "I also like drawing because it is fun.".
...
Catatan Penting: Bentuk "because" tidak sempurna seperti "because fun" tidak dikoreksi. Ini exposure pertama "because" di Fase C.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Hobi biasa dan tidak biasa diterima dengan nada yang sama.
...
Catatan Penting: Pratinjau "What you eat. And why." adalah undangan ke TP-07, bukan pengumuman materi.
