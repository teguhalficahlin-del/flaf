# TP-10 — WEATHER AND WHAT WE WEAR
...
| Text-anchor | "When it is rainy, I wear a raincoat. So I stay dry. I also bring an umbrella." |
| Connector aktif | when + so — exposure pasangan kondisi dan akibat; when fokus produksi di TP-14, so di TP-17 |
| Recycle Fase B | When it..., I... (TP-10 Fase B) · I also... (Fase A/B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Tulisan TP-09 | Guru mengaktifkan kembali deskripsi tempat dari TP-09. |
| 2 | Pembuka · Perkenalan Text-anchor dan Framing Inklusif | Guru memperkenalkan text-anchor dan pilihan cuaca bebas. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan dua situasi cuaca dengan when dan so. |
| 4 | Inti · My Weather Card | Guru memandu siswa mengisi kartu cuaca sendiri. |
| 5 | Inti · Drill Cepat Weather Call-and-Response | Guru melatih pasangan when dan respons. |
| 6 | Inti · INTERACT · Partner's Weather Card Exchange | Guru memandu siswa mengisi kartu pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Cuaca Sama Pilihan Berbeda | Guru memandu siswa membandingkan pilihan cuaca. |
| 8 | Inti · OUTPUT · Write When the Weather Changes | Guru memandu siswa menulis cuaca sendiri. |
...
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-11. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION TULISAN TP-09
...
Catatan Penting: Bridge "the place is the same, but the sky is different" menghubungkan TP-09 ke TP-10.
...
Catatan Penting: Framing "any weather near you" mencakup cuaca dengan variasi terbatas. Hot dan cloudy sama validnya dengan rainy.
...
Catatan Penting: when dan so muncul sebagai pasangan kondisi dan akibat, dimodelkan dua kali. Satu noticing saja, tidak lebih.

Darurat: —

---

## LAYAR 4 — INTI · MY WEATHER CARD

AKSI: Bagikan My Weather Card, satu per siswa.
...
Catatan Penting: Setiap siswa mengisi minimal satu baris, termasuk kolom "I wear / I bring", sebelum Layar 6. Kartu ini dipakai lagi di blok INTERACT.

Darurat: Jika ada siswa masih kosong setelah dua menit → dekati, tunjuk baris pertama kolom "Weather", bantu isi satu kata.

---

## LAYAR 5 — INTI · DRILL CEPAT WEATHER CALL-AND-RESPONSE

AKSI: Ucapkan "When it is rainy" dan ajak siswa melengkapi kalimat.
AKSI: Tunggu respons semua siswa.
...
## LAYAR 6 — INTI · INTERACT · PARTNER'S WEATHER CARD EXCHANGE

AKSI: Bagikan Partner's Weather Card, satu per siswa, semua kolom kosong.
...
Catatan Penting: Partner's Weather Card dibagikan dalam keadaan kosong. My Weather Card tetap tertutup selama pair work.
...
## LAYAR 7 — INTI · MINI-SHARE CUACA SAMA PILIHAN BERBEDA
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Jika semua pasangan sama, cukup angguk dan lanjut.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE WHEN THE WEATHER CHANGES
...
Catatan Penting: Tidak ada pattern reminder di papan tulis. Kalimat tanpa "so" tetap valid di TP-10.
...
AKSI: Untuk siswa yang butuh bantuan, dekati, tunjuk baris kedua di kartu, tanyakan "What about this weather? When it is the other weather, what do you do?".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat dengan so atau because, "When it is windy, I wear a jacket. So I feel warm.".
...
Catatan Penting: Connector "so" tidak dipaksakan. Ini exposure, fokus produksi baru di TP-17.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "who does the same thing" membangun komunitas.
...
Catatan Penting: "When it changes, you know what to do." adalah validasi fungsional, bukan recap materi.
