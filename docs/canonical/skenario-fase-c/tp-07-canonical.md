...
| Text-anchor | "I eat rice every day because it gives me energy. But I also like noodles." |
| Connector aktif | because + but — fokus produksi pertama; because tampil sebelum but di text-anchor dan model guru |
| Recycle Fase B | They eat... / I eat... (TP-09 Fase B) · I like... (TP-13 Fase B) · every day / always / usually (TP-06 Fase B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Hobi TP-06 | Guru mengaktifkan kembali pola I like because dari TP-06. |
| 2 | Pembuka · Perkenalan Text-Anchor dan Framing Inklusif | Guru memperkenalkan text-anchor dan pilihan makanan bebas. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan makanan dan memajankan because lalu but. |
| 4 | Inti · My Food Card | Guru memandu siswa mengisi kartu makanan sendiri. |
| 5 | Inti · Drill Cepat What Do You Eat Every Day | Guru melatih pola I eat dan kontras but. |
| 6 | Inti · INTERACT · Food Exchange Table | Guru memandu siswa mengisi tabel pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Kontras Paling Menarik | Guru memandu siswa membandingkan makanan. |
| 8 | Inti · OUTPUT · Write About My Food | Guru memandu siswa menulis makanan sendiri. |
...
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-08. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION HOBI TP-06
...
Catatan Penting: Reactivation di layar ini berasal dari tulisan siswa sendiri di TP-06, bukan dari text-anchor baru.
...
Catatan Penting: Framing inklusif hadir sebelum siswa mengisi kartu. Tidak ada makanan yang salah di layar ini.
...
Catatan Penting: Connector "because" muncul sebelum "but" di model guru, keduanya dalam kalimat terpisah. Jangan beri komentar tentang kedua connector.

Darurat: —

---

## LAYAR 4 — INTI · MY FOOD CARD

AKSI: Bagikan My Food Card, satu per siswa.
...
Catatan Penting: Setiap siswa mengisi minimal bagian "I eat ___" sebelum Layar 6. Kartu ini dipakai lagi di blok INTERACT.

Darurat: Jika ada siswa belum mengisi apa pun setelah tiga menit → dekati, tunjuk bagian "I eat ___", bantu isi satu kata.

---

## LAYAR 5 — INTI · DRILL CEPAT WHAT DO YOU EAT EVERY DAY
...
## LAYAR 6 — INTI · INTERACT · FOOD EXCHANGE TABLE

AKSI: Bagikan Food Exchange Table, satu per siswa, kolom My Partner's Food kosong.
...
Catatan Penting: Kolom My Food terisi sebelum pair work dimulai. Kolom My Partner's Food dibagikan dalam keadaan kosong.
...
## LAYAR 7 — INTI · MINI-SHARE KONTRAS PALING MENARIK
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Makanan yang tidak biasa dihargai setara dengan makanan umum.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE ABOUT MY FOOD
...
Catatan Penting: Text-anchor sudah diturunkan sebelum layar ini. Bentuk "because" atau "but" yang tidak sempurna diterima tanpa koreksi.
...
AKSI: Untuk siswa yang butuh bantuan, dekati dan ucapkan panduan konkret, "You wrote what you eat. Can you write why? I eat rice because it is filling.".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat kontras dengan but, "But I don't like vegetables.".
...
Catatan Penting: Bentuk "because" atau "but" tidak sempurna tidak dikoreksi. Ini produksi mandiri pertama kedua connector di Fase C.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Makanan biasa dan tidak biasa diterima dengan nada yang sama.
...
Catatan Penting: Pratinjau adalah undangan ke TP-08, bukan pengumuman tugas.
