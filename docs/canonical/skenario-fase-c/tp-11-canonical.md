...
| Text-anchor | "Cats eat fish. Birds can fly. Cows live on farms." |
| Connector aktif | — (tidak ada connector baru; connector yang sudah aktif tersedia jika muncul natural) |
| Recycle Fase B | They live in... / They eat... (TP-09 Fase B) · I can... menjadi [animal] can... (TP-16 Fase B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Tulisan TP-10 | Guru mengaktifkan kembali tulisan cuaca dari TP-10. |
| 2 | Pembuka · Perkenalan Text-anchor dan Framing Inklusif | Guru memperkenalkan fakta hewan dan pilihan hewan keseharian. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan pergeseran subjek dari I ke nama hewan. |
| 4 | Inti · My Animal Card | Guru memandu siswa mengisi kartu hewan sendiri. |
| 5 | Inti · Drill Cepat Animal Facts | Guru melatih pola It eats, It lives, It can. |
| 6 | Inti · INTERACT · Partner's Animal Card Exchange | Guru memandu siswa mengisi kartu pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Satu Fakta Menarik | Guru memandu siswa membagikan fakta hewan pasangan. |
| 8 | Inti · OUTPUT · Write About an Animal | Guru memandu siswa menulis fakta hewan sendiri. |
...
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-12. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION TULISAN TP-10
...
Catatan Penting: Bridge "not the sky, the ground" menghubungkan TP-10 ke TP-11.
...
Catatan Penting: Framing "any animal you know" mendorong pilihan spesifik dan personal, bukan hewan eksotis.
...
Catatan Penting: Tiga pasangan paralel menunjukkan pergeseran subjek dari I ke nama hewan. Jangan tambahkan contoh keempat atau penjelasan.

Darurat: —

---

## LAYAR 4 — INTI · MY ANIMAL CARD

AKSI: Bagikan My Animal Card, satu per siswa.
...
Catatan Penting: Setiap siswa memilih satu hewan spesifik dan mengisi baris "It can" sebelum Layar 6. Kartu ini dipakai lagi di blok INTERACT.

Darurat: Jika ada siswa masih kosong setelah tiga menit → dekati, tunjuk baris "Animal", bantu isi nama hewan.

---

## LAYAR 5 — INTI · DRILL CEPAT ANIMAL FACTS
...
## LAYAR 6 — INTI · INTERACT · PARTNER'S ANIMAL CARD EXCHANGE

AKSI: Bagikan Partner's Animal Card, satu per siswa, semua baris kosong.
...
AKSI: Minta siswa A bertanya ke siswa B lalu mengisi Partner's Animal Card.
AKSI: Minta siswa B bertanya ke siswa A lalu mengisi Partner's Animal Card.
...
Catatan Penting: Partner's Animal Card dibagikan dalam keadaan kosong. My Animal Card tetap tertutup selama pair work.
...
## LAYAR 7 — INTI · MINI-SHARE SATU FAKTA MENARIK
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Cukup satu fakta per pasangan.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE ABOUT AN ANIMAL
...
Catatan Penting: Pattern reminder adalah petunjuk struktur, bukan template isi. Isi tiap tulisan berasal dari kartu siswa sendiri.
...
AKSI: Untuk siswa yang butuh bantuan, dekati, tunjuk baris kartu yang belum dipakai, tanyakan "What about this? Where does it live? Write: It lives in...".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat yang menghubungkan hewan dengan pengalaman personal, "I like cats because they are quiet and soft.".
...
Catatan Penting: Connector yang muncul spontan diterima, tetapi tidak ada connector yang didorong di TP-11.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "who has the same animal" sederhana dan inklusif.
...
Catatan Penting: "Not about yourself. About the world around you." merangkum pergeseran dari diri sendiri ke fakta tentang dunia.
