# TP-02 — DESCRIBING PEOPLE I KNOW
...
| Text-anchor | "My father is tall. He has short hair. He is kind and funny." |
| Connector aktif | and + but — exposure only; fokus produksi di TP-07 |
| Recycle Fase B | She/He has... (TP-02 Fase B) · is [adjective] (Fase A/B) · I like... (TP-13 Fase B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Profil TP-01 | Guru mengaktifkan kembali pola kalimat profil dari TP-01. |
| 2 | Pembuka · Perkenalan Topik dan Framing Inklusif | Guru memperkenalkan text-anchor dan pilihan figur bebas. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan deskripsi dan memajankan connector but. |
| 4 | Inti · My Person Card | Guru memandu siswa memilih figur dan mengisi kartu. |
| 5 | Inti · Drill Cepat Describe and Guess | Guru melatih ritme deskripsi dan tebakan. |
| 6 | Inti · INTERACT · Comparison Table Exchange | Guru memandu siswa mengisi tabel pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Satu Kesamaan | Guru memandu siswa membandingkan figur. |
| 8 | Inti · OUTPUT · Write My Person | Guru memandu siswa menulis deskripsi figur sendiri. |
...
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-03. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION PROFIL TP-01
...
## LAYAR 2 — PEMBUKA · PERKENALAN TOPIK DAN FRAMING INKLUSIF
...
Catatan Penting: Text-anchor adalah satu contoh, bukan satu-satunya pilihan. Kalimat "you can describe anyone" adalah undangan terbuka, bukan aturan.
...
Catatan Penting: Connector "but" dimodelkan lewat dua kalimat pendek terpisah, exposure only. Jangan gunakan satu kalimat majemuk panjang.

Darurat: —

---

## LAYAR 4 — INTI · MY PERSON CARD

AKSI: Bagikan My Person Card, satu per siswa.
...
Catatan Penting: Setiap siswa memilih figur dan mengisi minimal dua baris sebelum Layar 6. Kartu ini dipakai lagi di blok INTERACT.
...
## LAYAR 5 — INTI · DRILL CEPAT DESCRIBE AND GUESS
...
## LAYAR 6 — INTI · INTERACT · COMPARISON TABLE EXCHANGE

AKSI: Bagikan Comparison Table, satu per siswa, kolom My Partner's Person kosong.
...
Catatan Penting: Kolom My Person terisi sebelum pair work dimulai. Kolom My Partner's Person dibagikan dalam keadaan kosong.
...
## LAYAR 7 — INTI · MINI-SHARE SATU KESAMAAN
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Pertanyaan "What is different?" dipakai sebagai fallback jika tidak ada kesamaan.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE MY PERSON
...
Catatan Penting: Text-anchor sudah diturunkan sebelum layar ini. Tiap deskripsi berbeda karena tiap siswa memilih figur yang berbeda.
...
AKSI: Untuk siswa yang butuh bantuan, dekati dan ucapkan kalimat pertama dengan figur siswa, lalu biarkan mereka melanjutkan.
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat kontras dengan but, "My sister is quiet, but my brother is loud.".
...
Catatan Penting: Yang diperiksa adalah apakah deskripsi mencerminkan orang nyata, bukan kelengkapan grammar.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan tentang teman atau guru lebih aman daripada tentang figur keluarga.
...
Catatan Penting: Kalimat terakhir adalah penutup sesi, bukan pengingat tugas.
