...
| Text-anchor | "There is a market near my school. It is big and busy. I go there with my mother." |
| Connector aktif | and — konfirmasi; tidak ada connector baru di TP-09 |
| Recycle Fase B | There is / There are... (TP-03 Fase B) · next to / across from (TP-03 Fase B) · I go there with... (Fase A/B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Tulisan TP-08 | Guru mengaktifkan kembali tulisan minggu dari TP-08. |
| 2 | Pembuka · Perkenalan Teks dan Framing Inklusif | Guru memperkenalkan text-anchor dan pilihan tempat bebas. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan dua tempat dan pola adjective and adjective. |
| 4 | Inti · My Town Card | Guru memandu siswa mengisi kartu tempat sendiri. |
| 5 | Inti · Drill Cepat Where Is It | Guru melatih pola lokasi near dan next to. |
| 6 | Inti · INTERACT · Partner's Town Card Exchange | Guru memandu siswa mengisi kartu pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Satu Tempat Menarik | Guru memandu siswa membagikan tempat pasangan. |
| 8 | Inti · OUTPUT · Write About a Place | Guru memandu siswa menulis deskripsi tempat sendiri. |
...
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-10. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION TULISAN TP-08
...
Catatan Penting: Reactivation mengaktifkan tulisan TP-08, jembatan dari Kluster B ke Kluster C.

Darurat: —

---

## LAYAR 2 — PEMBUKA · PERKENALAN TEKS DAN FRAMING INKLUSIF
...
Catatan Penting: Framing inklusif mencakup tempat non-urban secara eksplisit sebelum siswa mengisi kartu.
...
Catatan Penting: Model guru mencakup satu tempat non-urban. Pola "[adjective] and [adjective]" dimodelkan dua kali, tidak lebih.

Darurat: —

---

## LAYAR 4 — INTI · MY TOWN CARD

AKSI: Bagikan My Town Card, satu per siswa.
...
Catatan Penting: Setiap siswa mengisi minimal dua baris sebelum Layar 6, termasuk kolom "What is it like?". Kartu ini dipakai lagi di blok INTERACT.

Darurat: Jika ada siswa masih kosong setelah tiga menit → dekati, tunjuk baris "Place", bantu isi nama tempat.

---

## LAYAR 5 — INTI · DRILL CEPAT WHERE IS IT

AKSI: Tunjuk satu siswa secara acak.
...
## LAYAR 6 — INTI · INTERACT · PARTNER'S TOWN CARD EXCHANGE

AKSI: Bagikan Partner's Town Card, satu per siswa, semua kolom kosong.
...
Catatan Penting: Partner's Town Card dibagikan dalam keadaan kosong. My Town Card tetap tertutup selama pair work.
...
## LAYAR 7 — INTI · MINI-SHARE SATU TEMPAT MENARIK
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Tempat rural dan urban disebut sejajar.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE ABOUT A PLACE
...
Catatan Penting: Pattern reminder adalah petunjuk struktur, bukan template. Isi tiap tulisan berasal dari kartu siswa sendiri.
...
AKSI: Untuk siswa yang butuh bantuan, dekati, tunjuk baris kartu yang belum dipakai, tanyakan "What is this place like? Write: It is...".
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat dengan pola Kluster B, "I usually go there on Sunday with my friend.".
...
Catatan Penting: Connector "and" sudah cukup untuk TP-09. Connector lain yang muncul spontan diterima tanpa koreksi.
...
AKSI: Tanyakan siapa yang mau membacakan satu sampai dua kalimat dari deskripsi tempatnya.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "who has a place like this" inklusif.
...
Catatan Penting: Validasi "your place" penting untuk siswa yang mendeskripsikan tempat non-urban.
