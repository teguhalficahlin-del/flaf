# TP-05 — MY WEEK: ROUTINES AND PLANS
...
| Text-anchor | "On Monday I go to school. Last Monday I went to school early." |
| Connector aktif | then — exposure only; fokus produksi di TP-14. Past tense exposure pertama lewat text-anchor dan satu kalimat model guru |
| Recycle Fase B | On [day] I... (TP-07 Fase B) · I usually... / first, then, after that (TP-06 Fase B) · Yesterday I... / Last week I... (TP-05 Fase B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Tulisan TP-04 | Guru mengaktifkan kembali kalimat dari tulisan This Is Me. |
| 2 | Pembuka · Perkenalan Text-Anchor | Guru memperkenalkan kontras rutinitas dan minggu lalu. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan rutinitas dan memajankan connector then. |
| 4 | Inti · My Routine Card | Guru memandu siswa mengisi kartu rutinitas sendiri. |
| 5 | Inti · Drill Cepat What Do You Do on Monday | Guru melatih pola On day I dan Then I. |
| 6 | Inti · INTERACT · My Week Comparison Table Exchange | Guru memandu siswa mengisi tabel pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Sama atau Berbeda | Guru memandu siswa membandingkan minggu mereka. |
| 8 | Inti · OUTPUT · Write My Week | Guru memandu siswa menulis rutinitas sendiri. |
| 9 | Inti · Check and Extend | Guru memandu siswa memeriksa dan menambah kalimat. |
| 10 | Penutup · Sharing ke Kelas | Guru memandu siswa membagikan tulisan ke semua siswa. |
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-06. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION TULISAN TP-04
...
Catatan Penting: Reactivation mengaktifkan kalimat milik siswa sendiri dari tulisan TP-04.

Darurat: —

---

## LAYAR 2 — PEMBUKA · PERKENALAN TEXT-ANCHOR
...
Catatan Penting: Perbedaan ditunjukkan sebagai perbedaan waktu, bukan bentuk kata kerja. Jangan sebut "past tense".

Darurat: —

---

## LAYAR 3 — INTI · INPUT · MODEL GURU
...
Catatan Penting: Connector "then" muncul natural di model guru, exposure only. Kalimat past tense diucapkan sekali tanpa ditunjuk atau diulang.

Darurat: —

---

## LAYAR 4 — INTI · MY ROUTINE CARD

AKSI: Bagikan My Routine Card, satu per siswa.
...
Catatan Penting: Setiap siswa mengisi minimal bagian This week sebelum Layar 6. Kartu ini dipakai lagi di blok INTERACT.
...
## LAYAR 5 — INTI · DRILL CEPAT WHAT DO YOU DO ON MONDAY

AKSI: Tanyakan siapa yang mau berdiri.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 10 menit sebelum blok INTERACT.

Darurat: —

---

## LAYAR 6 — INTI · INTERACT · MY WEEK COMPARISON TABLE EXCHANGE

AKSI: Bagikan My Week Comparison Table, satu per siswa, kolom My Partner's Week kosong.
...
AKSI: Minta siswa A bertanya ke siswa B lalu mengisi kolom My Partner's Week.
AKSI: Minta siswa B bertanya ke siswa A lalu mengisi kolom My Partner's Week.
...
Catatan Penting: Kolom My Week terisi sebelum pair work dimulai. Kolom My Partner's Week dibagikan dalam keadaan kosong.
...
## LAYAR 7 — INTI · MINI-SHARE SAMA ATAU BERBEDA

AKSI: Tunjuk dua sampai tiga pasangan.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Bentuk past tense yang tidak sempurna diterima tanpa koreksi.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE MY WEEK

AKSI: Hapus atau tutup text-anchor dari papan tulis.
...
Catatan Penting: Text-anchor sudah diturunkan sebelum layar ini. Tiap tulisan berbeda karena tiap siswa punya rutinitas yang berbeda.
...
AKSI: Untuk siswa yang butuh bantuan, dekati dan ucapkan panduan konkret, "You wrote about Monday. What about another day?".
AKSI: Untuk siswa yang sudah bisa, minta tambah kalimat dengan then atau satu kalimat tentang minggu lalu, "On Monday I go to school. Then I study at home.".
...
Catatan Penting: Yang diperiksa adalah apakah tulisan mencerminkan minggu nyata siswa, bukan kelengkapan grammar.

Darurat: —

---

## LAYAR 10 — PENUTUP · SHARING KE KELAS

AKSI: Tanyakan siapa yang mau membacakan satu sampai dua kalimat dari tulisannya.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "who also does that..." inklusif dan tidak memaksa.

Darurat: —

---

## LAYAR 11 — PENUTUP · CLOSURE
...
Catatan Penting: Pratinjau "Why you do it" adalah undangan ke TP-06, bukan penugasan.
