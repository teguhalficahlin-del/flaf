# TP-03 — MY HOME AND NEIGHBORHOOD
...
| Text-anchor | "My house is near a mosque. There is a garden next to it. It is quiet and clean." |
| Connector aktif | and — reinforcement; fokus produksi di TP-04 |
| Recycle Fase B | There is / There are... (TP-03 Fase B) · next to / across from (TP-03 Fase B) · is [adjective] (Fase A/B) |
| Mode kluster | — |
...
| 1 | Pembuka · Reactivation Deskripsi TP-02 | Guru mengaktifkan kembali pola deskripsi dari TP-02. |
| 2 | Pembuka · Perkenalan Text-Anchor dan Framing Inklusif | Guru memperkenalkan text-anchor dan pilihan lingkungan bebas. |
| 3 | Inti · INPUT · Model Guru | Guru memodelkan deskripsi lingkungan dan memperkuat connector and. |
| 4 | Inti · My Neighborhood Card | Guru memandu siswa mengisi kartu lingkungan sendiri. |
| 5 | Inti · Drill Cepat What's Near Your House | Guru melatih ritme pertanyaan tentang tempat. |
| 6 | Inti · INTERACT · Neighborhood Comparison Table Exchange | Guru memandu siswa mengisi tabel pasangan lewat bertanya. |
| 7 | Inti · Mini-Share Sama atau Berbeda | Guru memandu siswa membandingkan lingkungan. |
| 8 | Inti · OUTPUT · Write My Neighborhood | Guru memandu siswa menulis deskripsi lingkungan sendiri. |
| 9 | Inti · Check and Extend | Guru memandu siswa memeriksa dan menambah kalimat. |
| 10 | Penutup · Sharing ke Kelas | Guru memandu siswa membagikan deskripsi ke semua siswa. |
| 11 | Penutup · Closure | Guru menutup sesi dan memberi pratinjau TP-04. |
...
## LAYAR 1 — PEMBUKA · REACTIVATION DESKRIPSI TP-02
...
Catatan Penting: Reactivation cukup dua sampai tiga kalimat dari siswa yang berbeda.
...
Catatan Penting: Text-anchor adalah satu contoh, bukan satu-satunya template. Kalimat "your neighborhood might be different" adalah undangan terbuka, bukan koreksi.
...
Catatan Penting: Model guru tentang lingkungan nyata guru. Connector "and" adalah reinforcement, bukan grammar baru.

Darurat: —

---

## LAYAR 4 — INTI · MY NEIGHBORHOOD CARD

AKSI: Bagikan My Neighborhood Card, satu per siswa.
...
Catatan Penting: Setiap siswa mengisi minimal baris pertama sebelum Layar 6. Kartu ini dipakai lagi di blok INTERACT.
...
## LAYAR 5 — INTI · DRILL CEPAT WHAT'S NEAR YOUR HOUSE
...
## LAYAR 6 — INTI · INTERACT · NEIGHBORHOOD COMPARISON TABLE EXCHANGE

AKSI: Bagikan Comparison Table, satu per siswa, kolom My Partner's Neighborhood kosong.
...
Catatan Penting: Kolom My Neighborhood terisi sebelum pair work dimulai. Kolom My Partner's Neighborhood dibagikan dalam keadaan kosong.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 12 menit. Pertanyaan "similar or different?" dipakai sebagai entri jawaban.

Darurat: —

---

## LAYAR 8 — INTI · OUTPUT · WRITE MY NEIGHBORHOOD
...
Catatan Penting: Text-anchor sudah diturunkan sebelum layar ini. Tiap deskripsi berbeda karena tiap siswa punya lingkungan yang berbeda.
...
AKSI: Untuk siswa yang butuh bantuan, dekati dan ucapkan kalimat pertama dengan informasi siswa, lalu biarkan mereka melanjutkan.
AKSI: Untuk siswa yang sudah bisa, minta tambah satu kalimat dengan and yang menghubungkan dua hal, "It is quiet and cool.".
...
Catatan Penting: Yang diperiksa adalah apakah deskripsi mencerminkan lingkungan nyata siswa, bukan kelengkapan grammar.
...
AKSI: Tanyakan siapa yang mau membacakan satu sampai dua kalimat dari deskripsinya.
...
Catatan Penting: Layar ini FLEX — lewati jika waktu tersisa kurang dari 5 menit. Pertanyaan "who also lives near..." inklusif dan tidak memaksa.
...
Catatan Penting: Kalimat terakhir adalah penutup sesi, bukan pengumuman tugas.
