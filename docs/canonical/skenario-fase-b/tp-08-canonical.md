# TP-08 — WRITING: MY WEEKLY SCHEDULE
...
| Recycle dari Fase A dan TP-05 sampai TP-07 | o'clock, half past, first, then, after that, I usually, Monday sampai Sunday, January sampai December, tomorrow, morning, afternoon, wake up, go to school, eat breakfast, sleep, one sampai twelve |
...
| 1 | Pembuka · Reconnect Chant Gabungan Kluster B | Guru menyalakan energi lewat chant gabungan tiga TP. |
| 2 | Pembuka · Warm-Up Review Kosakata TP-05 sampai TP-07 | Guru memanaskan memori lewat tanya jawab cepat. |
| 3 | Pembuka · Orientasi Panen | Guru menjelaskan target menulis jadwal mingguan. |
| 4 | Inti · Planning Memilih Lima Hari dan Kegiatan | Guru memandu siswa mengisi Planning Sheet. |
| 5 | Inti · Modeling Jadwal Mingguan Lengkap | Guru memodelkan contoh jadwal dan strukturnya. |
| 6 | Inti · Writing Draft Jadwal Mingguan | Guru memandu siswa menulis draf jadwal mingguan. |
| 7 | Inti · Berkeliling dan Penilaian Formatif | Guru berkeliling menilai dan mendampingi penulisan. |
| 8 | Inti · Silent Reread Garis Bawahi Hari Favorit | Guru memandu siswa membaca ulang dan menandai bagian favorit. |
| 9 | Inti · Peer Sharing Baca Satu Hari ke Partner | Guru memandu siswa membaca satu hari ke partner. |
| 10 | Inti · Mini Self-Check Days dan Time Expressions | Guru memandu siswa menemukan hari dan ekspresi waktu di tulisan mereka. |
| 11 | Penutup · Gallery Sharing Dua Suara | Guru memandu dua siswa membacakan satu hari. |
| 12 | Penutup · Closure Emosional Refleksi Kluster B | Guru menutup sesi dengan refleksi Kluster B dan teaser TP-09. |
...
Catatan Penting: Jangan mulai Layar 1 sebelum minimal 80 persen siswa menatap ke depan. Ucapkan "Today is a special day, again." dengan tulus, bukan terburu-buru.

Darurat: —

---

## LAYAR 1 — PEMBUKA · RECONNECT CHANT GABUNGAN KLUSTER B
...
Catatan Penting: Biarkan energi kelas naik selama chant, tetapi jaga suasana kelas agar tetap terkendali.

Darurat: —

---

## LAYAR 2 — PEMBUKA · WARM-UP REVIEW KOSAKATA TP-05 SAMPAI TP-07

AKSI: Tanyakan padanan Inggris dari "jam tujuh tepat".
...
Catatan Penting: Tidak ada jawaban yang salah selama hari, kegiatan, dan waktu ditulis dengan benar.

Darurat: —

---

## LAYAR 4 — INTI · PLANNING MEMILIH LIMA HARI DAN KEGIATAN
...
Catatan Penting: Siswa boleh menulis kegiatan dalam Bahasa Indonesia jika belum tahu Inggrisnya. Satu hari, satu kegiatan, satu waktu per baris.
...
## LAYAR 5 — INTI · MODELING JADWAL MINGGUAN LENGKAP
...
Catatan Penting: Contoh jadwal guru harus sudah disiapkan sebelum kelas. Jangan menulis contoh di depan siswa saat Layar 5 berlangsung.
...
AKSI: Di awal sesi kedua, minta siswa membuka Bagian A dan membaca ulang hari dan kegiatan yang mereka pilih.
AKSI: Di awal sesi kedua, minta siswa membuka Bagian B sebelum mulai menulis dari Layar 6.

Catatan Penting: Contoh jadwal guru harus tetap terlihat di awal sesi kedua. Jika di kertas besar, tempelkan kembali di papan tulis.

---

## LAYAR 6 — INTI · WRITING DRAFT JADWAL MINGGUAN
...
AKSI: Untuk siswa yang butuh bantuan, terima dua hari saja, satu kalimat per hari, seperti "On Monday, I go to school at seven o'clock. On Saturday, I stay at home.".
AKSI: Untuk siswa yang sudah bisa, minta tulis lima hari atau lebih dengan first, then, after that, lalu tambah kalimat penutup bebas.
...
Catatan Penting: Jangan perbaiki ejaan. Fokus hanya pada dua hal: ada nama hari yang disebut dan ada satu kegiatan untuk hari itu.
...
## LAYAR 8 — INTI · SILENT REREAD GARIS BAWAHI HARI FAVORIT
...
## LAYAR 9 — INTI · PEER SHARING BACA SATU HARI KE PARTNER
...
## LAYAR 10 — INTI · MINI SELF-CHECK DAYS DAN TIME EXPRESSIONS

UCAP: "Look at your writing one more time."
...
Catatan Penting: Guru tidak mengumpulkan atau menilai hasil melingkari dan menggaris bawahi. Ini self-check siswa, bukan evaluasi.

Darurat: Jika waktu tersisa kurang dari 8 menit → lewati layar ini, langsung ke Layar 11.

---

## LAYAR 11 — PENUTUP · GALLERY SHARING DUA SUARA
...
Catatan Penting: Pilih siswa yang berbeda dari peserta paling aktif di Layar 2.

Darurat: —

---

## LAYAR 12 — PENUTUP · CLOSURE EMOSIONAL REFLEKSI KLUSTER B
...
Catatan Penting: Ucapkan "Nobody else has the same week." dengan tulus. Akhiri sesi dengan ritual goodbye, bukan instruksi administratif.
