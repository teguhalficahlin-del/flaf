...
| Recycle dari Fase A dan TP-12 sampai TP-14 | doctor, farmer, She works at, rendang, spicy, I like because, Eid, visit, On we, grandmother, family, happy, because, rice |
...
| 1 | Pembuka · Reconnect Chant Gabungan Kluster D | Guru menyalakan energi lewat chant gabungan tiga TP. |
| 2 | Pembuka · Warm-Up Review Kosakata TP-12 sampai TP-14 | Guru memanaskan memori lewat tanya jawab cepat. |
| 3 | Pembuka · Orientasi Panen | Guru menjelaskan target menulis teks tentang negara. |
| 4 | Inti · Planning Memilih Profesi Makanan Perayaan | Guru memandu siswa mengisi Planning Sheet. |
| 5 | Inti · Modeling Teks My Country Lengkap | Guru memodelkan teks contoh dan strukturnya. |
| 6 | Inti · Writing Draft Teks My Country | Guru memandu siswa menulis draf teks. |
| 7 | Inti · Berkeliling dan Penilaian Formatif | Guru berkeliling menilai dan mendampingi penulisan. |
| 8 | Inti · Silent Reread Underline Favorite Sentence | Guru memandu siswa membaca ulang dan menandai kalimat favorit. |
| 9 | Inti · Peer Sharing Baca Bagian Favorit ke Partner | Guru memandu siswa membaca bagian favorit ke partner. |
| 10 | Inti · Mini Self-Check Tiga Topik dalam Teks | Guru memandu siswa menemukan tiga topik di teks mereka. |
| 11 | Penutup · Gallery Sharing Dua Suara | Guru memandu dua siswa membacakan satu bagian. |
| 12 | Penutup · Closure Emosional Refleksi Kluster D | Guru menutup sesi dengan refleksi Kluster D dan teaser TP-16. |
...
## LAYAR 1 — PEMBUKA · RECONNECT CHANT GABUNGAN KLUSTER D
...
Catatan Penting: Biarkan energi kelas naik selama chant, tetapi jaga tetap terkendali.

Darurat: —

---

## LAYAR 2 — PEMBUKA · WARM-UP REVIEW KOSAKATA TP-12 SAMPAI TP-14
...
Catatan Penting: Jaga ritme cepat, satu pertanyaan tiap 5 detik.
...
Catatan Penting: Setiap Indonesia yang ditulis siswa valid. Tidak ada satu jawaban yang benar.

Darurat: —

---

## LAYAR 4 — INTI · PLANNING MEMILIH PROFESI MAKANAN PERAYAAN
...
Catatan Penting: Siswa boleh memilih profesi, makanan, dan perayaan apa pun di luar contoh TP-12 sampai TP-14.
...
## LAYAR 5 — INTI · MODELING TEKS MY COUNTRY LENGKAP
...
Catatan Penting: Teks contoh harus sudah disiapkan sebelum kelas. Jangan menulis teks di depan siswa saat Layar 5 berlangsung.
...
AKSI: Di awal sesi kedua, minta siswa membuka Bagian A dan membaca ulang profesi, makanan, dan perayaan yang mereka pilih.
AKSI: Di awal sesi kedua, minta siswa membuka Bagian B sebelum mulai menulis dari Layar 6.

Catatan Penting: Teks contoh guru harus tetap terlihat di awal sesi kedua. Jika di kertas besar, tempelkan kembali di papan tulis.

---

## LAYAR 6 — INTI · WRITING DRAFT TEKS MY COUNTRY
...
AKSI: Untuk siswa yang butuh bantuan, cukup tulis tiga bagian, job, food, dan celebration.
AKSI: Untuk siswa yang sudah bisa, setelah lima bagian selesai, minta tambah satu paragraf, "One thing I want the world to know about Indonesia is ___.".
...
Catatan Penting: Jangan potong Layar 6 lebih awal dari 8 menit. Pertahankan struktur pengingat di papan tulis sampai Layar 10 selesai.
...
AKSI: Lanjutkan memantau penulisan semua siswa dari Layar 6.
...
Catatan Penting: Cek satu hal saja: apakah tiga topik profesi, makanan, dan perayaan muncul. Jangan koreksi grammar.
...
## LAYAR 8 — INTI · SILENT REREAD UNDERLINE FAVORITE SENTENCE
...
## LAYAR 9 — INTI · PEER SHARING BACA BAGIAN FAVORIT KE PARTNER
...
Catatan Penting: Minta siswa menyebut satu hal yang disukai, bukan koreksi.
...
## LAYAR 10 — INTI · MINI SELF-CHECK TIGA TOPIK DALAM TEKS

UCAP: "Look at your text one more time."
...
Catatan Penting: Guru tidak menilai hasil melingkari dan menggaris bawahi. Ini self-check siswa.
...
## LAYAR 12 — PENUTUP · CLOSURE EMOSIONAL REFLEKSI KLUSTER D
...
Catatan Penting: Ucapkan "Nobody else has the same Indonesia." dengan tulus. Akhiri sesi dengan ritual goodbye, bukan instruksi administratif.
