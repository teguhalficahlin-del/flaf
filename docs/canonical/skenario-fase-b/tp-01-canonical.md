...
| Kosakata baru | library, canteen, raise your hand |
| Recycle dari Fase A | pencil, book, sit down, listen, write, read, open, bag |
...
| 1 | Pembuka · Chant Reactivation | Guru menyalakan energi lewat chant kosakata Fase A. |
| 2 | Pembuka · Reactivation Tanya-Jawab | Guru meninjau kosakata lama lewat tanya jawab cepat. |
| 3 | Inti · Introduksi Library dan Canteen | Guru memperkenalkan dua tempat baru di sekolah. |
| 4 | Inti · Drill Kosakata Tempat | Guru memimpin drill nama tempat di sekolah. |
| 5 | Inti · Introduksi Raise Your Hand | Guru memperkenalkan prosedur mengangkat tangan. |
| 6 | Inti · Praktik Raise Your Hand dalam Konteks | Guru melatih raise your hand lewat tanya jawab. |
| 7 | Inti · Reset dan Latihan Berpasangan | Guru memandu latihan tanya jawab berpasangan. |
| 8 | Inti · Menulis Kalimat Sederhana | Guru memandu siswa mengisi tiga kalimat rumpang. |
| 9 | Inti · Berkeliling dan Review Tulisan | Guru meninjau hasil tulisan dan mengeja kata sulit. |
| 10 | Penutup · Review Cepat | Guru mengonsolidasi tiga kosakata inti. |
| 11 | Penutup · Closure Emosional | Guru menutup sesi dengan refleksi singkat. |
...
Catatan Penting: Jangan mulai Layar 1 sebelum minimal 80 persen kelas menatap ke depan.

Darurat: —

---

## LAYAR 1 — PEMBUKA · CHANT REACTIVATION
...
Catatan Penting: Biarkan energi kelas naik selama chant. Turunkan energi di Layar 2.

Darurat: Jika kelas gaduh sebelum chant selesai → hentikan chant, tepuk tangan sekali, ucapkan "Freeze", langsung ke Layar 2.

---

## LAYAR 2 — PEMBUKA · REACTIVATION TANYA-JAWAB
...
Catatan Penting: Jangan berhenti di satu kata lebih dari 5 detik. Jika siswa lupa sebuah kata, ucapkan sendiri lalu lanjut.

Darurat: —

---

## LAYAR 3 — INTI · INTRODUKSI LIBRARY DAN CANTEEN
...
Catatan Penting: Pastikan kedua gambar terlihat jelas dari semua sudut kelas sebelum mulai bicara. Jika tidak ada gambar, gambar kotak berlabel besar di papan tulis.

Darurat: —

---

## LAYAR 4 — INTI · DRILL KOSAKATA TEMPAT
...
AKSI: Untuk siswa yang butuh bantuan, terima jawaban satu kata "library" atau "canteen".
AKSI: Untuk siswa yang sudah bisa, minta kalimat penuh "This is the library." atau "This is the canteen.".
...
Catatan Penting: Bolak-balik dua gambar tanpa jeda panjang. Munculkan urutan yang tidak terduga.

Darurat: —

---

## LAYAR 5 — INTI · INTRODUKSI RAISE YOUR HAND
...
Catatan Penting: Pastikan seluruh kelas dapat melakukan gerakan raise your hand dengan benar sebelum lanjut ke Layar 6.

Darurat: —

---

## LAYAR 6 — INTI · PRAKTIK RAISE YOUR HAND DALAM KONTEKS

UCAP: "I have a question."
...
AKSI: Untuk siswa yang butuh bantuan, terima jawaban satu kata.
AKSI: Untuk siswa yang sudah bisa, ucapkan "Can you say a full sentence?" setelah mereka menjawab.
...
Catatan Penting: Prioritaskan siswa yang belum pernah dinilai di TP ini. Jangan berhenti pada satu siswa lebih dari 5 detik.

Darurat: —

---

## LAYAR 7 — INTI · RESET DAN LATIHAN BERPASANGAN

AKSI: Minta siswa duduk tegak.
...
AKSI: Untuk siswa yang sudah bisa, minta pasangan menukar peran penanya dan penjawab.
...
## LAYAR 8 — INTI · MENULIS KALIMAT SEDERHANA
...
AKSI: Untuk siswa yang butuh bantuan, izinkan melihat tulisan di papan tulis dan menggambar tangan terangkat untuk kalimat ketiga.
AKSI: Untuk siswa yang sudah bisa, minta menambahkan satu kalimat bebas tentang sekolah setelah tiga kalimat selesai.

BANTUAN: Jika siswa berhenti dan bingung: dekati, bisikkan "What place do you go to read books?", tunjuk tulisan di papan tulis.

Catatan Penting: Jangan koreksi ejaan saat siswa menulis. Fokus pada kebenaran konsep kata, bukan ejaan.
...
Catatan Penting: Pilih siswa yang berbeda dari peserta Layar 6.

Darurat: Jika waktu tersisa kurang dari 10 menit → lewati layar ini, langsung ke Layar 10.

---

## LAYAR 10 — PENUTUP · REVIEW CEPAT
...
Catatan Penting: Jaga ritme tetap tenang di layar ini. Ini konsolidasi, bukan drill.
...
Catatan Penting: Kalimat terakhir guru harus terasa seperti penutup, bukan pengumuman administratif.
