# TP-07 — DAYS, MONTHS, AND THE CALENDAR
...
| Total layar | 12 (termasuk Layar 0) |
| Kosakata baru | Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, January sampai December, tomorrow |
| Recycle dari Fase A dan TP-05 sampai TP-06 | one sampai twenty, morning, afternoon, first, then, after that, I usually, o'clock, half past, wake up, go to school |
...
| 1 | Pembuka · Koneksi TP-06 dan Chant Hari | Guru menghubungkan TP-06 dan memperkenalkan tujuh hari lewat chant. |
| 2 | Pembuka · Reactivation Numbers dan Morning Afternoon | Guru meninjau angka dan penanda waktu hari. |
| 3 | Inti · Drill Hari Monday sampai Sunday | Guru memimpin drill nama hari. |
| 4 | Inti · Konteks Hari On Monday I | Guru memodelkan kalimat berkonteks hari dan jam. |
| 5 | Inti · Introduksi Bulan Konteks Ulang Tahun | Guru memperkenalkan dua belas bulan lewat konteks ulang tahun. |
| 6 | Inti · Introduksi Tomorrow | Guru memperkenalkan kata tomorrow dengan hari nyata. |
| 7 | Inti · Pair Practice Ceritakan Jadwal Satu Hari | Guru memandu latihan bercerita satu hari berpasangan. |
| 8 | Inti · Writing Individual Jadwal Mingguan | Guru memandu siswa menulis jadwal mingguan. |
| 9 | Inti · Berkeliling dan Review Tulisan | Guru meninjau hasil tulisan dan mengaktifkan kembali nama bulan. |
| 10 | Penutup · Review dan Hapus Papan | Guru mengonsolidasi hari, bulan, dan tomorrow lalu menghapus papan tulis. |
| 11 | Penutup · Closure Emosional dan Teaser TP-08 | Guru menutup sesi dengan refleksi dan teaser TP-08. |
...
Catatan Penting: Jangan mulai Layar 1 sebelum minimal 80 persen siswa menatap ke depan.

Darurat: —

---

## LAYAR 1 — PEMBUKA · KONEKSI TP-06 DAN CHANT HARI
...
Catatan Penting: Ucapkan jembatan ke TP-06 sebelum chant dimulai, bukan sesudahnya.
...
## LAYAR 2 — PEMBUKA · REACTIVATION NUMBERS DAN MORNING AFTERNOON

AKSI: Tulis angka 1 sampai 12 di papan tulis dengan nama Inggrisnya, seperti 1 = one, 2 = two, sampai 12 = twelve.
...
Catatan Penting: Pertahankan angka 1 sampai 12 di papan tulis sampai Layar 5 selesai.

Darurat: —

---

## LAYAR 3 — INTI · DRILL HARI MONDAY SAMPAI SUNDAY

AKSI: Tempel kartu tujuh hari di papan tulis dalam dua baris: Monday, Tuesday, Wednesday, Thursday di baris pertama; Friday, Saturday, Sunday di baris kedua.
...
AKSI: Untuk siswa yang butuh bantuan, terima nama hari saat ditunjuk tanpa konteks before atau after.
AKSI: Untuk siswa yang sudah bisa, minta ucapkan hari dalam kalimat, seperti "Monday comes before Tuesday.".
...
## LAYAR 4 — INTI · KONTEKS HARI ON MONDAY I
...
Catatan Penting: Tunjuk kalimat "On Monday, I go to school at seven o'clock." sebagai contoh kalimat lengkap yang menggabungkan hari, kegiatan, dan jam.

Darurat: —

---

## LAYAR 5 — INTI · INTRODUKSI BULAN KONTEKS ULANG TAHUN
...
Catatan Penting: Fokus pada tiga sampai empat bulan yang paling sering muncul dari jawaban kelas. Target layar ini adalah mengenali bulan ulang tahun, bukan menghafal dua belas bulan.
...
## LAYAR 6 — INTI · INTRODUKSI TOMORROW

UCAP: "Good. We know the months. Now, something closer. Just one day away."
...
Catatan Penting: Gunakan nama hari yang sebenarnya hari ini, bukan contoh abstrak.

Darurat: —

---

## LAYAR 7 — INTI · PAIR PRACTICE CERITAKAN JADWAL SATU HARI
...
AKSI: Untuk siswa yang butuh bantuan, terima satu kalimat saja, "On Monday, I go to school.".
AKSI: Untuk siswa yang sudah bisa, minta ceritakan dua atau tiga kegiatan dalam satu hari dengan first, then, after that.
...
## LAYAR 8 — INTI · WRITING INDIVIDUAL JADWAL MINGGUAN

UCAP: "Okay. Take your pencil. Let's write."
AKSI: Jeda 3 detik.
...
AKSI: Untuk siswa yang butuh bantuan, izinkan mengisi hanya tiga baris pertama, Monday, Tuesday, dan Wednesday.
AKSI: Untuk siswa yang sudah bisa, setelah tabel selesai, minta tambah satu kalimat "On Saturday, I usually" dengan kegiatan akhir pekan.
...
Catatan Penting: Terima isian o'clock di kolom mana pun, termasuk baris Wednesday. Jangan koreksi siswa yang belum memakai half past.
...
Catatan Penting: Pilih siswa yang berbeda dari peserta Layar 3.

Darurat: Jika waktu tersisa kurang dari 10 menit → lewati layar ini, langsung ke Layar 10.

---

## LAYAR 10 — PENUTUP · REVIEW DAN HAPUS PAPAN
...
Catatan Penting: Jaga ritme review tetap cepat. Beri maksimal 5 detik per respons, lalu ucapkan jawabannya sendiri dan lanjut.

Darurat: —

---

## LAYAR 11 — PENUTUP · CLOSURE EMOSIONAL DAN TEASER TP-08

AKSI: Minta siswa duduk tegak dan rileks.
AKSI: Turunkan volume suara.
...
Catatan Penting: Akhiri sesi dengan ritual goodbye, bukan instruksi administratif. Ucapkan teaser TP-08 dengan nada antusias.
