...
| Kosakata baru | curly, straight, kind, She has |
| Recycle dari Fase A | mother, father, eyes, hands, colors (red, black, brown), happy |
...
| 1 | Pembuka · Koneksi TP-01 dan Chant Warna | Guru menghubungkan pelajaran lalu dan menyalakan energi lewat chant. |
| 2 | Pembuka · Reactivation Family dan Body Parts | Guru meninjau kosakata keluarga, anggota tubuh, dan warna. |
| 3 | Inti · Introduksi Curly dan Straight | Guru memperkenalkan dua jenis rambut. |
| 4 | Inti · Drill Curly, Straight, dan Warna Rambut | Guru memimpin drill jenis dan warna rambut. |
| 5 | Inti · Introduksi Kind | Guru memperkenalkan sifat kind. |
| 6 | Inti · Modeling Kalimat She Has | Guru memodelkan kalimat deskripsi orang. |
| 7 | Inti · Latihan Berpasangan Deskripsi Teman | Guru memandu latihan deskripsi berpasangan. |
| 8 | Inti · Menulis Kalimat Deskripsi | Guru memandu siswa menulis kalimat deskripsi. |
| 9 | Inti · Berkeliling dan Review Tulisan | Guru meninjau hasil tulisan dan pola She has. |
| 10 | Penutup · Review Cepat | Guru mengonsolidasi kosakata inti. |
| 11 | Penutup · Closure Emosional | Guru menutup sesi dengan refleksi dan teaser TP-03. |
...
## LAYAR 1 — PEMBUKA · KONEKSI TP-01 DAN CHANT WARNA
...
Catatan Penting: Biarkan energi kelas naik selama chant.
...
## LAYAR 2 — PEMBUKA · REACTIVATION FAMILY DAN BODY PARTS

AKSI: Tunjuk gambar ibu.
UCAP: "Who is this?"
AKSI: Tunggu respons semua siswa.
...
Catatan Penting: Jangan berhenti di satu item lebih dari 5 detik. Jika siswa lupa sebuah kata, ucapkan sendiri lalu lanjut.

Darurat: —

---

## LAYAR 3 — INTI · INTRODUKSI CURLY DAN STRAIGHT
...
Catatan Penting: Jangan tunjuk rambut siswa tertentu tanpa izin. Pakai rambut guru sendiri sebagai contoh utama.

Darurat: —

---

## LAYAR 4 — INTI · DRILL CURLY, STRAIGHT, DAN WARNA RAMBUT
...
AKSI: Untuk siswa yang butuh bantuan, terima jawaban satu kata "curly" atau "straight".
AKSI: Untuk siswa yang sudah bisa, minta kalimat "My hair is straight." atau "My hair is curly and black.".
...
Catatan Penting: Ucapkan dua contoh konkret kind dengan jelas sebelum lanjut.

Darurat: —

---

## LAYAR 6 — INTI · MODELING KALIMAT SHE HAS
...
Catatan Penting: Pertahankan keempat kalimat di papan tulis sampai Layar 8 selesai. Jangan hapus sebelum semua siswa selesai menulis.

Darurat: —

---

## LAYAR 7 — INTI · LATIHAN BERPASANGAN DESKRIPSI TEMAN
...
AKSI: Untuk siswa yang butuh bantuan, terima satu kalimat "She has curly hair.".
AKSI: Untuk siswa yang sudah bisa, minta dua kalimat atau lebih, termasuk "She is kind.".
...
## LAYAR 8 — INTI · MENULIS KALIMAT DESKRIPSI
...
AKSI: Untuk siswa yang butuh bantuan, izinkan menyalin struktur dari papan tulis dan hanya mengganti nama dan satu adjektif.
AKSI: Untuk siswa yang sudah bisa, minta menambahkan satu kalimat bebas seperti "She likes reading." atau "She is my friend." setelah template selesai.

BANTUAN: Jika siswa ragu memilih orang: bisikkan "Choose your mother, your friend, or a character from a book.", lalu lanjut.

Catatan Penting: Siswa boleh menulis tentang karakter fiksi atau tokoh buku, tidak harus teman sekelas. Jangan paksa siswa menulis tentang orang tertentu.
...
Catatan Penting: Jangan koreksi she dan he di depan kelas. Beri catatan lembut di kertas siswa.
