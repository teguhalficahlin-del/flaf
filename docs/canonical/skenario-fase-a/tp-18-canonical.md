...
| Total layar | 9 (termasuk Layar 0) |
| Kelas | 2 |
...
| 1 | Pembuka · Set Tone Perayaan | Guru membangun suasana perayaan penutup Fase A. |
| 2 | Pembuka · Demo Template Poster | Guru memperkenalkan empat bagian poster dan memodelkan kalimatnya. |
| 3 | Inti · Pembuatan Poster | Guru memandu siswa mengisi poster dalam batas waktu. |
| 4 | Inti · Demo Presentasi Guru | Guru mendemokan cara presentasi dan ritual thumbs up. |
| 5 | Inti · Sesi Presentasi | Guru memandu setiap siswa mempresentasikan posternya. |
| 6 | Reset · Jeda Setelah Presentasi | Guru menenangkan kelas sebelum puncak perayaan. |
| 7 | Penutup · Celebration | Guru memimpin perayaan penyelesaian Fase A. |
| 8 | Penutup · Closure Ritual | Guru menutup Fase A lewat ritual baris per baris. |
...
## LAYAR 1 — PEMBUKA · SET TONE PERAYAAN
...
Catatan Penting: Jeda 3 detik setelah kalimat hari terakhir Phase A wajib. Berhenti setelah "I will help you", jangan tambahkan kalimat lain.

Darurat: —

---

## LAYAR 2 — PEMBUKA · DEMO TEMPLATE POSTER

AKSI: Ambil template poster contoh dari meja guru.
...
Catatan Penting: Template terlihat jelas dari belakang kelas. Pakai contoh keluarga netral "big family", bukan "happy family" atau "complete family".

Darurat: —

---

## LAYAR 3 — INTI · PEMBUATAN POSTER

UCAP: "Now flip your poster."
UCAP: "Face up."
...
Catatan Penting: Jangan beri instruksi apa pun selama siswa masih membalik poster. Terima tulisan maupun gambar, dan ejaan bukan prioritas.

Darurat: —

---

## LAYAR 4 — INTI · DEMO PRESENTASI GURU

AKSI: Ambil kembali template poster contoh dari meja guru.
AKSI: Berdiri di depan kelas.
...
Catatan Penting: Thumbs up diperkenalkan dan dilatih sebelum sesi presentasi dimulai. Presentasi dari tempat duduk dihitung penuh, tidak wajib maju ke depan.

Darurat: —

---

## LAYAR 5 — INTI · SESI PRESENTASI
...
Catatan Penting: Thumbs up adalah ritual tetap setelah setiap presenter, bukan tepuk tangan bebas. Jangan koreksi grammar; keberanian dan usaha adalah prioritas di layar ini.
...
## LAYAR 6 — RESET · JEDA SETELAH PRESENTASI
...
Catatan Penting: Ucapkan dua kalimat saja, jangan langsung masuk ke celebration. Jeda 2 detik tanpa bertanya apa pun.

Darurat: —

---

## LAYAR 7 — PENUTUP · CELEBRATION
...
Catatan Penting: Pimpin "clap for yourself" sebelum "clap for your friends". Beri sinyal tangan turun setelah tepuk tangan kedua sebelum kalimat penutup.

Darurat: —

---

## LAYAR 8 — PENUTUP · CLOSURE RITUAL
...
Catatan Penting: Ucapkan ritual baris per baris dan tunggu kelas mengulang setiap baris. Jeda 3 detik di akhir, jangan tambahkan komentar apa pun setelahnya.
