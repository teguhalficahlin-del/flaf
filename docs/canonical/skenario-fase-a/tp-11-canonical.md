...
| 1 | Pembuka · Hook Rutinitas Pagi | Guru memancing minat lewat peragaan rutinitas pagi. |
| 2 | Inti · Listen First Gelombang 1 | Guru memperkenalkan empat kegiatan pertama. |
| 3 | Inti · Produksi Bersama Gelombang 1 | Guru memimpin produksi frasa dan gestur empat kegiatan pertama. |
| 4 | Inti · Reactivation + Listen First Gelombang 2 | Guru meninjau gelombang 1 dan memperkenalkan empat kegiatan berikutnya. |
| 5 | Inti · Produksi Bersama Gelombang 2 + Gabungan | Guru memimpin produksi delapan kegiatan dalam tiga fase. |
| 6 | Inti · Reset Sebelum Struktur | Guru menenangkan kelas sebelum masuk struktur kalimat. |
| 7 | Inti · Listen First Struktur "First ... Then ..." | Guru memodelkan pola "First, I ... Then, I ...". |
| 8 | Inti · Produksi Bersama "First ... Then ..." | Guru memimpin produksi pola "First ... Then ...". |
| 9 | Inti · Demo Cerita Rutinitas + Partner Practice | Guru mendemokan cerita rutinitas dan memandu latihan berpasangan. |
| 10 | Penutup · Reset + Choral Rutinitas | Guru memimpin choral rutinitas dengan frame penuh. |
| 11 | Penutup · Survei Oral Cepat | Guru memimpin survei oral cepat. |
...
## LAYAR 1 — PEMBUKA · HOOK RUTINITAS PAGI
...
Catatan Penting: Gestur muncul sebelum kata di setiap frasa. Jika kelas diam total: lanjutkan monolog dan gestur, ajak kelas ikut di akhir.
...
Catatan Penting: Ucapkan frasa dua kata secara natural, jangan dipenggal. Jaga gestur eat breakfast berbeda dari eat dinner.

Darurat: —

---

## LAYAR 3 — INTI · PRODUKSI BERSAMA GELOMBANG 1
...
Catatan Penting: Pertahankan gestur sepanjang kedua putaran. Jangan lepaskan gestur di putaran kedua.
...
Catatan Penting: Jaga gestur eat breakfast dan eat dinner tetap berbeda. Lakukan contrast drill di layar ini, jangan dilewati.

Darurat: —

---

## LAYAR 5 — INTI · PRODUKSI BERSAMA GELOMBANG 2 + GABUNGAN
...
Catatan Penting: Untuk frasa dua kata, kejelasan lebih penting daripada kecepatan. Jangan penggal suku kata.

Darurat: —

---

## LAYAR 6 — INTI · RESET SEBELUM STRUKTUR
...
## LAYAR 7 — INTI · LISTEN FIRST STRUKTUR "FIRST ... THEN ..."
...
Catatan Penting: Tunjuk papan tulis setiap mengucapkan "First" dan "Then". Berikan dua pasang contoh, bukan satu.

Darurat: —

---

## LAYAR 8 — INTI · PRODUKSI BERSAMA "FIRST ... THEN ..."
...
Catatan Penting: Lakukan choral frame penuh sebelum fill-in-the-blank. Tunjuk papan tulis setiap kelas mulai menghilangkan "First" atau "Then".

Darurat: —

---

## LAYAR 9 — INTI · DEMO CERITA RUTINITAS + PARTNER PRACTICE
...
Catatan Penting: Listener wajib menunjuk kartu saat partner bercerita. Jangan koreksi grammar saat latihan berlangsung.

Darurat: Jika waktu ≤10 menit → lewati demo dan partner practice, langsung ke Layar 10.

---

## LAYAR 10 — PENUTUP · RESET + CHORAL RUTINITAS
...
Catatan Penting: Putaran kedua menggunakan frame "First ... Then ...", bukan nama frasa saja. Cukup dua kartu, tidak semua delapan.

Darurat: —

---

## LAYAR 11 — PENUTUP · SURVEI ORAL CEPAT
...
Catatan Penting: Survei maksimal dua pertanyaan. Modelkan jawaban sebelum bertanya kepada kelas.
...
AKSI: Pegang kartu eat breakfast dan kartu go to school.
...
Catatan Penting: Gunakan dua kartu berdampingan dengan struktur "First ... Then ...". Urutan berbeda dari rutinitas sehari-hari tetap diterima.
