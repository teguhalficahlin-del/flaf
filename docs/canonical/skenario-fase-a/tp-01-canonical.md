# TP-01 — GREETINGS & FAREWELLS

**Canonical TP · Standar Emas FLAF v1.4**
...
| Total layar | 18 (termasuk Layar 0) |
| Kelas | — (belum tercantum di skenario lama) |
...
| Layar | Judul | Tujuan |
|-------|-------|--------|
| 0 | Pre-Opening · Door Greeting | Guru menyambut siswa satu per satu di pintu dengan boneka Kiki. |
| 1 | Pembuka · Demo Boneka | Guru memperagakan dialog salam pagi dengan Kiki dan Momo. |
| 2 | Pembuka · Interaksi Kelas | Guru mengajak semua siswa membalas sapaan bersama. |
| 3 | Pembuka · Kartu Waktu | Guru memperkenalkan tiga waktu lewat kartu waktu. |
| 4 | Inti · Demo 4 Salam | Guru memperagakan empat salam dengan Kiki dan Momo. |
| 5 | Inti · Drill | Guru memimpin pengulangan empat salam bersama semua siswa. |
| 6 | Inti · Chant Demo | Guru memperagakan chant salam satu putaran penuh. |
| 7 | Inti · Chant Bersama | Guru memimpin chant bersama semua siswa. |
| 8 | Inti · Reset + Game | Guru menenangkan kelas dan menjelaskan aturan game. |
| 9 | Inti · Game | Guru memimpin game salam berebut poin. |
| 10 | Inti · Real Life | Guru menghubungkan salam dengan situasi di rumah. |
| 11 | Inti · Farewell Intro | Guru memperkenalkan ungkapan perpisahan. |
| 12 | Inti · Farewell Drill | Guru memimpin pengulangan ungkapan perpisahan. |
| 13 | Inti · Diferensiasi | Guru memberi pilihan latihan dengan atau tanpa kartu. |
| 14 | Penutup · Review | Guru menguji ingatan siswa lewat kartu waktu. |
| 15 | Penutup · Refleksi | Guru menanyakan salam favorit setiap siswa. |
| 16 | Penutup · Penutup Kelas | Guru menutup kelas dengan salam perpisahan bersama. |
| 17 | Penutup Sesi · Selesai | Guru membereskan media dan mencatat observasi siswa. |

---

## LAYAR 0 — PRE-OPENING · DOOR GREETING
...
Catatan Penting: Boneka Kiki wajib ada di tangan sepanjang layar ini. Layar ini tidak boleh dilewati.

Darurat: —

---

## LAYAR 1 — PEMBUKA · DEMO BONEKA

AKSI: Ajak semua siswa duduk.
AKSI: Pegang Kiki di tangan kiri.
...
Catatan Penting: Demo boneka hanya sekali. Jangan ulang demo boneka.

Darurat: —

---

## LAYAR 2 — PEMBUKA · INTERAKSI KELAS
...
Catatan Penting: Langsung modelkan jawaban tanpa jeda setelah ucapkan "Say it with me!".

Darurat: —

---

## LAYAR 3 — PEMBUKA · KARTU WAKTU

AKSI: Ambil kartu waktu.
...
Catatan Penting: Condongkan badan dan naikkan alis setelah ucapkan "Now, what time is this?". Tunggu respons sebelum lanjut.

Darurat: —

---

## LAYAR 4 — INTI · DEMO 4 SALAM

AKSI: Tempel empat kartu salam di papan tulis satu per satu.
...
Catatan Penting: Gerakkan tangan seperti orang tidur saat ucapkan "Good night".
...
Catatan Penting: Peragakan chant sambil duduk. Demo satu putaran penuh, siswa belum ikut.

Darurat: —

---

## LAYAR 7 — INTI · CHANT BERSAMA
...
Catatan Penting: Putaran kedua lebih cepat dari putaran pertama, siswa tetap duduk selama chant. Berhenti saat energi masih tinggi.

Darurat: —

---

## LAYAR 8 — INTI · RESET + GAME
...
Catatan Penting: Tunggu sampai kelas benar-benar diam sebelum menjelaskan aturan game.

Darurat:
- Jika waktu ≤10 menit → lewati game, langsung ke Layar 10.

---

## LAYAR 9 — INTI · GAME

AKSI: Angkat satu kartu salam ke semua siswa.
...
Catatan Penting: Batasi game 5–6 putaran. Berhenti sebelum energi turun.

Darurat: —

---

## LAYAR 10 — INTI · REAL LIFE
...
## LAYAR 11 — INTI · FAREWELL INTRO

AKSI: Angguk dan tersenyum ke semua siswa.
...
Catatan Penting: Gerakkan tangan seperti melambai pergi saat ucapkan "And when you leave?".

Darurat: —

---

## LAYAR 12 — INTI · FAREWELL DRILL
...
Catatan Penting: Diferensiasi dilakukan setelah semua siswa mengikuti latihan bersama.

Darurat: Jika waktu sangat mepet → lewati diferensiasi, langsung ke Layar 14.

---

## LAYAR 14 — PENUTUP · REVIEW
...
## LAYAR 16 — PENUTUP · PENUTUP KELAS
...
Catatan Penting: Demo boneka hanya sekali. Langsung pindah ke ucapan bersama setelah demo selesai.

Darurat: —

---

## LAYAR 17 — PENUTUP SESI · SELESAI

AKSI: Kumpulkan kartu waktu dan kartu salam.
