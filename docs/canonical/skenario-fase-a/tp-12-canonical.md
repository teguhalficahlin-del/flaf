...
| 1 | Pembuka · Hook Lagu | Guru membangkitkan energi lewat lagu bagian tubuh. |
| 2 | Pembuka · Reset + Anchor ke Vocab | Guru menurunkan energi dan mengaitkan lagu dengan kosakata. |
| 3 | Inti · Listen First Gelombang 1 | Guru memperkenalkan empat bagian tubuh pertama. |
| 4 | Inti · Produksi Bersama Gelombang 1 + Contrast Drill | Guru memimpin produksi dan membedakan eyes dengan ears. |
| 5 | Inti · Reactivation + Listen First Gelombang 2 | Guru meninjau gelombang 1 dan memperkenalkan empat bagian berikutnya. |
| 6 | Inti · Produksi Gabungan | Guru memimpin produksi delapan bagian tubuh dalam tiga fase. |
| 7 | Inti · TPR "Touch Your ..." | Guru memimpin retrieval lewat perintah menyentuh tanpa kartu. |
| 8 | Inti · Reset + Listen First Struktur "I use my ... to ..." | Guru memodelkan pola "I use my ... to ...". |
| 9 | Inti · Produksi Bersama + Demo Partner | Guru memimpin produksi pola dan mendemokan latihan berpasangan. |
| 10 | Inti · Partner Practice | Guru memandu latihan berpasangan dengan kartu. |
| 11 | Penutup · Reset + Choral Body Parts | Guru memimpin choral bagian tubuh dengan frame penuh. |
...
Catatan Penting: Lagu ini dipakai untuk membangkitkan semangat kelas, jangan berhenti untuk mengoreksi lafal.

Darurat: —

---

## LAYAR 2 — PEMBUKA · RESET + ANCHOR KE VOCAB
...
Catatan Penting: Empat kata diucapkan guru saja, kelas belum diminta produksi. Buat gestur besar dan lambat.

Darurat: —

---

## LAYAR 3 — INTI · LISTEN FIRST GELOMBANG 1
...
Catatan Penting: Buat gestur eyes dan ears jelas berbeda. Kelas belum diminta produksi di layar ini.

Darurat: —

---

## LAYAR 4 — INTI · PRODUKSI BERSAMA GELOMBANG 1 + CONTRAST DRILL
...
Catatan Penting: Contrast drill eyes dan ears tidak boleh dilewati. Jaga gestur tetap konsisten di layar berikutnya.

Darurat: —

---

## LAYAR 5 — INTI · REACTIVATION + LISTEN FIRST GELOMBANG 2
...
Catatan Penting: Lakukan contrast drill legs dan feet di layar ini. Gunakan anchor "up here" dan "down here", bukan hanya nama kartu.

Darurat: —

---

## LAYAR 6 — INTI · PRODUKSI GABUNGAN
...
Catatan Penting: Pertahankan gestur sepanjang seluruh fase. Jika ada siswa yang hanya bicara tanpa gestur: modelkan ulang sambil berjalan melewatinya, jangan hentikan kelas.

Darurat: —

---

## LAYAR 7 — INTI · TPR "TOUCH YOUR ..."
...
Catatan Penting: Kartu sudah dilepas; retrieval berasal dari memori, bukan dari kartu.

Darurat: —

---

## LAYAR 8 — INTI · RESET + LISTEN FIRST STRUKTUR "I USE MY ... TO ..."
...
Catatan Penting: Tunjuk papan tulis setiap mengucapkan "I use my" dan "to". Beri jeda 1 detik antara "I use my" dan "to" di setiap kalimat.

Darurat: —

---

## LAYAR 9 — INTI · PRODUKSI BERSAMA + DEMO PARTNER
...
Catatan Penting: Lakukan choral frame penuh sebelum fill-in-the-blank. Listener wajib mengulang kalimat partner.
...
## LAYAR 11 — PENUTUP · RESET + CHORAL BODY PARTS
...
Catatan Penting: Putaran kedua menggunakan frame "I use my ... to ...", bukan nama kartu saja. Cukup dua kartu, tidak semua delapan.
...
AKSI: Pegang kartu eyes dan kartu ears.
...
Catatan Penting: Gunakan dua kartu pasangan contrast yaitu eyes dan ears dengan struktur "I use my ... to ...". Tidak diperluas.
