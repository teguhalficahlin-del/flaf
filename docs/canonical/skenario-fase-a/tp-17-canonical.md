...
| Total layar | 15 (termasuk Layar 0) |
| Kelas | 2 |
...
| Layar | Judul | Tujuan |
|-------|-------|--------|
| 0 | Pre-Opening · Pembuka Kelas | Guru mengunci perhatian siswa sebelum sesi dimulai. |
| 1 | Pembuka · Hook Guru Model Hobi | Guru memancing minat lewat peragaan hobinya sendiri. |
| 2 | Inti · Listen First Gelombang 1 | Guru memperkenalkan empat hobi pertama. |
| 3 | Inti · Produksi Bersama Gelombang 1 + Contrast Drill | Guru memimpin produksi dan membedakan reading dengan drawing. |
| 4 | Inti · Reactivation + Listen First Gelombang 2 | Guru meninjau gelombang 1 dan memperkenalkan empat hobi berikutnya. |
| 5 | Inti · Produksi Gabungan Delapan Hobi + Contrast Drill | Guru memimpin produksi delapan hobi dan membedakan swimming dengan cycling. |
| 6 | Inti · TPR "Show Me ..." | Guru memimpin retrieval lewat perintah bergestur tanpa kartu. |
| 7 | Inti · Reset + Listen First Frame "I like ... because it is ..." | Guru memodelkan pola "I like ... because it is ...". |
| 8 | Inti · Produksi Bersama Frame Kalimat | Guru memimpin produksi pola dengan model penuh lalu fill-in. |
| 9 | Inti · Whole-Class QA Drill + Demo Partner | Guru memimpin drill tanya jawab dan mendemokan tugas berpasangan. |
| 10 | Inti · Pair Dialogue | Guru memandu dialog berpasangan dengan kartu hobi. |
| 11 | Penutup · Reset + Thumbs Up Survey | Guru memimpin survei jempol yang aman secara sosial. |
| 12 | Penutup · Retrieval Choral Hobi + Frame | Guru memimpin choral hobi dengan frame penuh. |
| 13 | Penutup · Exit Ticket | Guru mengecek pemahaman lewat satu kalimat. |
| 14 | Penutup · Closing | Guru menutup kelas. |

---

## LAYAR 0 — PRE-OPENING · PEMBUKA KELAS
...
Catatan Penting: Layar ini tidak boleh dilewati.

Darurat: —

---

## LAYAR 1 — PEMBUKA · HOOK GURU MODEL HOBI

AKSI: Berdiri di tengah kelas.
...
Catatan Penting: Guru yang bergestur, bukan siswa. Cukup tiga hobi, jangan perkenalkan delapan hobi di layar ini.

Darurat: —

---

## LAYAR 2 — INTI · LISTEN FIRST GELOMBANG 1
...
Catatan Penting: Bedakan reading dan drawing lewat gestur: reading tangan diam, drawing tangan bergerak. Kelas belum diminta produksi di layar ini.

Darurat: —

---

## LAYAR 3 — INTI · PRODUKSI BERSAMA GELOMBANG 1 + CONTRAST DRILL
...
Catatan Penting: Contrast drill memasangkan reading dengan drawing. Bedakan lewat gestur tangan, bukan kata-katanya.

Darurat: —

---

## LAYAR 4 — INTI · REACTIVATION + LISTEN FIRST GELOMBANG 2

AKSI: Peragakan gestur reading, drawing, singing, dan dancing berurutan.
UCAP: "Quick check."
...
Catatan Penting: Lakukan reactivation gelombang pertama tanpa mengoreksi. Bedakan swimming dan cycling lewat gestur: swimming kedua lengan ke samping, cycling setir dan kaki mengayuh.

Darurat: —

---

## LAYAR 5 — INTI · PRODUKSI GABUNGAN DELAPAN HOBI + CONTRAST DRILL
...
Catatan Penting: Contrast drill memasangkan swimming dengan cycling. Pada fase cepat cukup tunjuk kartu tanpa membuat gestur penuh.

Darurat: Jika energi kelas sudah terlalu tinggi setelah fase sedang → langsung ke fase cepat tanpa mengulang.

---

## LAYAR 6 — INTI · TPR "SHOW ME ..."

AKSI: Lepaskan semua kartu dari papan tulis.
...
Catatan Penting: Retrieval berasal dari memori tubuh, bukan dari kartu. Putaran acak maksimal lima cue, lalu berhenti.

Darurat: —

---

## LAYAR 7 — INTI · RESET + LISTEN FIRST FRAME "I LIKE ... BECAUSE IT IS ..."
...
Catatan Penting: Buat gestur dan tunjuk kartu sebelum mengucapkan setiap kalimat. Gunakan "fun" dan "interesting" bergantian di tiga contoh.

Darurat: —

---

## LAYAR 8 — INTI · PRODUKSI BERSAMA FRAME KALIMAT
...
Catatan Penting: Pertahankan urutan model penuh, ulang penuh, lalu fill-in. Variasikan alasan antara "fun" dan "interesting".

Darurat: —

---

## LAYAR 9 — INTI · WHOLE-CLASS QA DRILL + DEMO PARTNER
...
Catatan Penting: Lakukan QA drill dua putaran sebelum demo. Bisikkan hobi kepada siswa A, jangan ucapkan ke semua siswa.

Darurat: —

---

## LAYAR 10 — INTI · PAIR DIALOGUE

AKSI: Lepaskan kartu reading, dancing, dan cooking dari papan tulis.
...
Catatan Penting: Selesaikan distribusi kartu sebelum instruksi practice. Jangan koreksi grammar saat berkeliling.
...
## LAYAR 11 — PENUTUP · RESET + THUMBS UP SURVEY
...
Catatan Penting: Terima jempol dan diam tanpa komentar. Jangan menghitung jumlah dan jangan membandingkan pilihan.

Darurat: —

---

## LAYAR 12 — PENUTUP · RETRIEVAL CHORAL HOBI + FRAME
...
Catatan Penting: Putaran kedua memakai frame "I like ... because it is ...", bukan nama hobi saja. Cukup dua hobi, tidak semua delapan.

Darurat: —

---

## LAYAR 13 — PENUTUP · EXIT TICKET

UCAP: "Take your pencil."
...
Catatan Penting: Gunakan gestur cycling, bukan reading atau singing. Satu hobi, satu kalimat, satu alasan.

Darurat: —

---

## LAYAR 14 — PENUTUP · CLOSING
