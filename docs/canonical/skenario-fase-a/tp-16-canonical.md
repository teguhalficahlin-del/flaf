...
| Tema | Literasi Awal |
| Total layar | 14 (termasuk Layar 0) |
| Kelas | 2 |
...
| 1 | Pembuka · Hook Prediksi | Guru memancing antisipasi lewat sampul cerita. |
| 2 | Inti · Story Listening | Guru menceritakan kisah sambil memperlihatkan gambar. |
| 3 | Inti · Whole-Class Comprehension QA | Guru mengecek pemahaman lewat tiga pertanyaan. |
| 4 | Inti · Listen First Kata Urutan | Guru memperkenalkan empat kata urutan dengan gestur dua lapis. |
| 5 | Inti · Produksi Bersama + Apply ke Cerita | Guru memimpin produksi kata urutan dan menerapkannya ke kalimat cerita. |
| 6 | Inti · TPR Sequencing | Guru memimpin retrieval kata urutan lewat gestur tanpa papan tulis. |
| 7 | Inti · Reset + Distribusi Kartu Urutan | Guru membagikan kartu urutan dan mengecek kesiapan. |
| 8 | Inti · Demo Partner Retelling | Guru mendemokan tugas storyteller dan listener. |
| 9 | Inti · Pair Retelling | Guru memandu latihan retelling berpasangan. |
| 10 | Penutup · Reset + Refleksi Emosi Tokoh | Guru memimpin refleksi observasional tentang tokoh cerita. |
| 11 | Penutup · Retrieval Choral Sequencing | Guru memimpin choral kata urutan dan kalimat cerita. |
| 12 | Penutup · Exit Ticket | Guru mengecek pemahaman lewat satu kalimat. |
| 13 | Penutup · Closing | Guru menutup kelas. |
...
## LAYAR 1 — PEMBUKA · HOOK PREDIKSI

AKSI: Pegang buku cerita.
...
Catatan Penting: Jangan konfirmasi prediksi benar atau salah; terima semua dengan anggukan. Jangan buka halaman dalam di layar ini.

Darurat: —

---

## LAYAR 2 — INTI · STORY LISTENING
...
Catatan Penting: Buku selalu menghadap kelas dan gambar terlihat semua siswa. Berhenti untuk prediksi hanya satu kali, antara halaman satu dan dua.

Darurat: —

---

## LAYAR 3 — INTI · WHOLE-CLASS COMPREHENSION QA

AKSI: Pegang buku terbuka di halaman yang relevan.
...
Catatan Penting: Dahului setiap pertanyaan dengan perintah "Point to". Terima jawaban Bahasa Indonesia dan campuran, dan batasi pada tiga pertanyaan.

Darurat: —

---

## LAYAR 4 — INTI · LISTEN FIRST KATA URUTAN
...
Catatan Penting: Gestur dua lapis selalu muncul bersama: posisi tangan kiri ke kanan dan gestur aksi cerita. Ucapkan "After that" pelan, kelas belum diminta produksi di layar ini.

Darurat: —

---

## LAYAR 5 — INTI · PRODUKSI BERSAMA + APPLY KE CERITA
...
Catatan Penting: Gestur dua lapis wajib di setiap kalimat dan kelas mengulang kalimat penuh, bukan hanya kata urutan. Tunjuk papan tulis sebelum mengucapkan kalimat, bukan setelah.

Darurat: —

---

## LAYAR 6 — INTI · TPR SEQUENCING

AKSI: Hapus tulisan "First", "Then", "After that", dan "Finally" dari papan tulis.
...
Catatan Penting: Gestur identik dengan Layar 4 dan Layar 5, tanpa improvisasi gestur baru. Maksimal empat putaran acak tanpa guru mengucapkan kata, lalu freeze sebelum distribusi kartu.

Darurat: —

---

## LAYAR 7 — INTI · RESET + DISTRIBUSI KARTU URUTAN
...
Catatan Penting: Selesaikan distribusi sebelum instruksi apa pun tentang cara memakai kartu. Cek kartu "First" dan "Finally" setelah distribusi.

Darurat: —

---

## LAYAR 8 — INTI · DEMO PARTNER RETELLING
...
Catatan Penting: Lakukan demo sebagai Storyteller dengan satu siswa sukarela sebagai Listener sebelum pair practice. Gestur dua lapis tetap dipakai dan latih stop signal sebelum "Go".

Darurat: —

---

## LAYAR 9 — INTI · PAIR RETELLING

UCAP: "Partner A tells."
UCAP: "Partner B holds cards."
UCAP: "Raise when you hear the word."
...
Catatan Penting: Cek apakah Listener aktif mengangkat kartu dan jangan koreksi grammar saat berkeliling. Buku tertutup di meja, boleh dilihat sebentar jika lupa.

Darurat: Jika volume kelas naik terlalu tinggi → tepuk tangan sekali, duduk diam 3 detik, lalu lanjut.

---

## LAYAR 10 — PENUTUP · RESET + REFLEKSI EMOSI TOKOH

AKSI: Ambil kembali buku cerita dari meja guru.
AKSI: Tepuk tangan sekali.
UCAP: "Stop."
UCAP: "Cards down."
UCAP: "Eyes on me."
...
Catatan Penting: Guru menyebut fakta cerita, bukan interpretasi moral. Diam 5 detik tanpa pertanyaan, dan refleksi maksimal 2 menit.

Darurat: —

---

## LAYAR 11 — PENUTUP · RETRIEVAL CHORAL SEQUENCING

AKSI: Tulis kembali "First", "Then", "After that", dan "Finally" di papan tulis berurutan dari kiri ke kanan.
...
Catatan Penting: Gestur dua lapis identik dengan Layar 4, 5, 6, dan 8. Pada putaran acak kartu, tahan 1 detik sebelum lanjut.

Darurat: —

---

## LAYAR 12 — PENUTUP · EXIT TICKET
...
Catatan Penting: Pilih kartu "Then", bukan "First" atau "Finally". Tahan kartu yang sama selama siswa menulis, satu kata urutan dan satu kalimat.

Darurat: —

---

## LAYAR 13 — PENUTUP · CLOSING
