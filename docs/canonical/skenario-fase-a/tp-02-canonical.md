...
| Total layar | 17 (termasuk Layar 0) |
| Kelas | 1 |
...
| Layar | Judul | Tujuan |
|-------|-------|--------|
| 0 | Pre-Opening · Door Greeting | Guru menyambut siswa di depan kelas tanpa boneka. |
| 1 | Pembuka · Guru Memperkenalkan Diri | Guru memperkenalkan namanya dan menuliskannya di papan tulis. |
| 2 | Pembuka · Siswa Menjawab Sapaan | Guru mengajak semua siswa menyebut nama guru. |
| 3 | Pembuka · Jembatan ke Inti | Guru menjembatani ke perkenalan nama siswa. |
| 4 | Inti · Pola "My Name Is" | Guru memperkenalkan pola kalimat "My name is". |
| 5 | Inti · Name Tag | Guru membagikan dan memandu pengisian name tag. |
| 6 | Inti · Jembatan ke Usia | Guru menjembatani dari nama ke usia. |
| 7 | Inti · Pola Usia | Guru memperkenalkan pola kalimat usia. |
| 8 | Inti · Demo Walk and Talk | Guru memperagakan walk and talk dengan Kiki dan Momo. |
| 9 | Inti · Reset + Aturan Walk and Talk | Guru menenangkan kelas dan menjelaskan aturan walk and talk. |
| 10 | Inti · Walk and Talk | Guru memimpin walk and talk bersama semua siswa. |
| 11 | Inti · Diferensiasi | Guru memberi pilihan latihan dengan atau tanpa papan tulis. |
| 12 | Penutup · Transisi + Demo Guru | Guru memperagakan ulang perkenalan diri sebelum sesi tampil. |
| 13 | Penutup · Tampil di Depan | Guru memandu 2–3 siswa tampil memperkenalkan diri. |
| 14 | Penutup · Refleksi | Guru menanyakan satu nama teman yang siswa kenal. |
| 15 | Penutup · Penutup Kelas | Guru menutup kelas dengan salam perpisahan bersama. |
| 16 | Penutup Sesi · Selesai | Guru membereskan media dan mencatat observasi siswa. |
...
Catatan Penting: Lakukan layar ini tanpa boneka. Layar ini tidak boleh dilewati.

Darurat: —

---

## LAYAR 1 — PEMBUKA · GURU MEMPERKENALKAN DIRI
...
Catatan Penting: Tunjuk nama di papan tulis saat mengucapkannya.

Darurat: —

---

## LAYAR 2 — PEMBUKA · SISWA MENJAWAB SAPAAN
...
Catatan Penting: Tunggu 2 detik setelah ucapkan "What is my name?" sebelum modelkan jawaban.

Darurat: —

---

## LAYAR 3 — PEMBUKA · JEMBATAN KE INTI
...
## LAYAR 4 — INTI · POLA "MY NAME IS"

AKSI: Tulis kalimat "My name is ___." di papan tulis.
...
## LAYAR 5 — INTI · NAME TAG

AKSI: Bagikan kertas name tag ke semua siswa.
...
Catatan Penting: Keliling kelas dan bantu siswa satu per satu. Tunjuk garis kosong di name tag saat mengucapkan instruksi.

Darurat: Jika ada siswa belum bisa menulis nama → gunakan name tag pre-printed sebagai cadangan.

---

## LAYAR 6 — INTI · JEMBATAN KE USIA

AKSI: Tunggu sampai semua siswa memakai name tag.
...
## LAYAR 8 — INTI · DEMO WALK AND TALK
...
## LAYAR 9 — INTI · RESET + ATURAN WALK AND TALK
...
## LAYAR 10 — INTI · WALK AND TALK

AKSI: Ajak semua siswa memulai walk and talk.
...
Catatan Penting: Tepuk tangan dua kali untuk menghentikan walk and talk saat waktu habis.

Darurat: —

---

## LAYAR 11 — INTI · DIFERENSIASI

AKSI: Ajak semua siswa duduk kembali.
...
Catatan Penting: Diferensiasi dilakukan setelah semua siswa mengikuti walk and talk.

Darurat: Jika waktu mepet → batasi latihan berpasangan pada 2 menit.

---

## LAYAR 12 — PENUTUP · TRANSISI + DEMO GURU
...
Catatan Penting: Jaga setiap giliran tetap pendek.

Darurat: Jika tidak ada siswa sukarela → tunjuk 2 siswa sekaligus.

---

## LAYAR 14 — PENUTUP · REFLEKSI

AKSI: Tunjuk name tag tiga sampai empat siswa secara acak.
...
## LAYAR 15 — PENUTUP · PENUTUP KELAS
...
## LAYAR 16 — PENUTUP SESI · SELESAI

AKSI: Kumpulkan kertas name tag.
