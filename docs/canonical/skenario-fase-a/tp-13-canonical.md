...
| 1 | Pembuka · Hook Cuaca Hari Ini | Guru memancing minat lewat cuaca nyata di luar kelas. |
| 2 | Inti · Listen First Gelombang 1 | Guru memperkenalkan empat kata cuaca pertama. |
| 3 | Inti · Produksi Bersama Gelombang 1 + Contrast Drill | Guru memimpin produksi dan membedakan sunny dengan rainy. |
| 4 | Inti · Reactivation + Listen First Gelombang 2 | Guru meninjau gelombang 1 dan memperkenalkan hot dan cold. |
| 5 | Inti · Produksi Gabungan Enam Kartu | Guru memimpin produksi enam kata cuaca dalam tiga fase. |
| 6 | Inti · TPR "Show Me ..." | Guru memimpin retrieval lewat perintah bergestur tanpa kartu. |
| 7 | Inti · Reset + Listen First "Today is ... / The weather is ..." | Guru memodelkan pola "Today is ... The weather is ...". |
| 8 | Inti · Produksi Bersama Anchor Struktur | Guru memimpin produksi pola dan transfer ke cuaca nyata. |
| 9 | Inti · Listen First "When it is ..., I ..." + Demo Partner | Guru memodelkan pola sebab-tindakan dan mendemokan latihan berpasangan. |
| 10 | Inti · Partner Practice | Guru memandu latihan berpasangan dengan kartu. |
| 11 | Penutup · Reset + Choral Weather | Guru memimpin choral cuaca dengan frame penuh. |
| 12 | Penutup · Exit Ticket | Guru mengecek pemahaman lewat dua kalimat. |
...
## LAYAR 1 — PEMBUKA · HOOK CUACA HARI INI
...
Catatan Penting: Guru yang berjalan ke jendela, bukan siswa. Terima respons bebas siswa tanpa koreksi.
...
Catatan Penting: Gunakan arah ayun windy yang sama sepanjang sesi. Kelas belum diminta produksi di layar ini.
...
Catatan Penting: Contrast drill memasangkan sunny dengan rainy, bukan sunny dengan cloudy. Pertahankan gestur konsisten di layar berikutnya.
...
AKSI: Tunjuk empat kartu gelombang pertama berurutan.
UCAP: "Quick check."
...
Catatan Penting: Lakukan reactivation gelombang pertama tanpa mengoreksi. Gestur hot mengarah keluar dan gestur cold mengarah ke dalam — jaga arah tetap berlawanan.

Darurat: —

---

## LAYAR 5 — INTI · PRODUKSI GABUNGAN ENAM KARTU
...
Catatan Penting: Pertahankan gestur sepanjang seluruh fase. Jangan letakkan hot dan cold berurutan pada putaran acak.
...
Catatan Penting: Kartu sudah dilepas; retrieval berasal dari memori. Putaran acak maksimal lima cue, lalu berhenti.

Darurat: —

---

## LAYAR 7 — INTI · RESET + LISTEN FIRST "TODAY IS ... / THE WEATHER IS ..."
...
Catatan Penting: Tunjuk papan tulis setiap mengucapkan "Today is" dan "The weather is". Modelkan tiga pasang kalimat, bukan satu.

Darurat: —

---

## LAYAR 8 — INTI · PRODUKSI BERSAMA ANCHOR STRUKTUR
...
Catatan Penting: Dua struktur "Today is" dan "The weather is" selalu berpasangan. Lakukan transfer cuaca nyata secara choral, bukan tanya individual.

Darurat: —

---

## LAYAR 9 — INTI · LISTEN FIRST "WHEN IT IS ..., I ..." + DEMO PARTNER
...
Catatan Penting: Beri jeda 1 detik antara "When it is" dan "I" di setiap kalimat. Demo partner dan latihan listener mengulang kalimat dilakukan sebelum partner practice.
...
Catatan Penting: Listener wajib mengulang kalimat, bukan hanya menonton. Jangan koreksi grammar saat berkeliling.

Darurat: Jika waktu ≤10 menit → lewati partner practice, langsung ke Layar 11.

---

## LAYAR 11 — PENUTUP · RESET + CHORAL WEATHER
...
Catatan Penting: Putaran kedua menggunakan frame "When it is ..., I ...", bukan nama kartu saja. Cukup dua kartu, tidak semua enam.
...
AKSI: Pegang kartu rainy dan kartu sunny.
...
Catatan Penting: Gunakan dua kartu pasangan contrast yaitu rainy dan sunny dengan struktur "When it is ..., I ...". Tidak diperluas.
