...
| 1 | Pembuka · Hook Benda di Kelas | Guru memancing minat lewat benda di sekitar kelas. |
| 2 | Inti · Listen First Gelombang 1 | Guru memperkenalkan tiga benda kelas pertama. |
| 3 | Inti · Produksi Bersama Gelombang 1 + Contrast Drill | Guru memimpin produksi dan membedakan pen dengan pencil. |
| 4 | Inti · Reactivation + Listen First Gelombang 2 | Guru meninjau gelombang 1 dan memperkenalkan tiga benda berikutnya. |
| 5 | Inti · Produksi Gabungan | Guru memimpin produksi enam benda dalam tiga fase. |
| 6 | Inti · TPR "Show Me ..." | Guru memimpin retrieval lewat perintah menunjukkan benda tanpa kartu. |
| 7 | Inti · Reset + Listen First Preposisi "On, In, Under" | Guru memodelkan tiga preposisi dengan benda nyata. |
| 8 | Inti · Produksi Bersama Kalimat Preposisi | Guru memimpin produksi pola "The ... is ... the ...". |
| 9 | Inti · Permainan "Where Is the ...?" + Demo Partner | Guru memimpin permainan tanya jawab dan mendemokan latihan berpasangan. |
| 10 | Inti · Partner Practice | Guru memandu latihan berpasangan dengan benda sendiri. |
| 11 | Penutup · Reset + Choral Benda + Preposisi | Guru memimpin choral benda kelas dengan frame penuh. |
...
## LAYAR 1 — PEMBUKA · HOOK BENDA DI KELAS
...
Catatan Penting: Guru yang menunjuk dan menyebut, bukan meminta siswa menebak. Terima respons bebas siswa tanpa koreksi.
...
Catatan Penting: Buat gestur pen dan pencil jelas berbeda. Kelas belum diminta produksi di layar ini.
...
Catatan Penting: Contrast drill pen dan pencil tidak boleh dilewati. Gunakan anchor "ink" dan "wood", jangan jelaskan artinya.
...
AKSI: Tunjuk tiga kartu gelombang pertama berurutan dengan cepat.
UCAP: "Quick check."
...
Catatan Penting: Lakukan reactivation gelombang pertama sebelum gelombang kedua, tanpa mengoreksi. Buat gestur eraser besar dan jelas, tangan bergerak kiri-kanan di udara.

Darurat: —

---

## LAYAR 5 — INTI · PRODUKSI GABUNGAN
...
Catatan Penting: Jangan letakkan pen dan pencil berurutan pada fase cepat. Kejelasan lebih penting daripada kecepatan.
...
Catatan Penting: Retrieval berasal dari benda nyata di meja siswa, bukan dari kartu. Pilih maksimal lima cue dan jangan letakkan pen dan pencil berurutan.

Darurat: —

---

## LAYAR 7 — INTI · RESET + LISTEN FIRST PREPOSISI "ON, IN, UNDER"
...
Catatan Penting: Setiap preposisi memakai gestur tangan berbeda dan konsisten: on tangan datar di atas, in tangan masuk ke dalam, under tangan ke bawah. Semua modeling posisi harus terlihat dari belakang kelas.

Darurat: —

---

## LAYAR 8 — INTI · PRODUKSI BERSAMA KALIMAT PREPOSISI
...
Catatan Penting: Gerakkan benda fisik sebelum mengucapkan setiap kalimat. Lakukan choral frame penuh sebelum fill-in.

Darurat: —

---

## LAYAR 9 — INTI · PERMAINAN "WHERE IS THE ...?" + DEMO PARTNER

AKSI: Ambil penghapus dari meja guru.
...
Catatan Penting: Lakukan whole-class QA drill sebelum demo partner. Pakai satu benda per putaran dan listener wajib bertanya "Where is the book?", bukan hanya menebak.

Darurat: —

---

## LAYAR 10 — INTI · PARTNER PRACTICE

AKSI: Biarkan siswa memakai benda di meja masing-masing: buku, pensil, dan penghapus.
...
Catatan Penting: Benda disembunyikan tetapi tetap terlihat oleh partner. Jangan koreksi grammar saat berkeliling.

Darurat: Jika waktu ≤10 menit → lewati partner practice, langsung ke Layar 11.

---

## LAYAR 11 — PENUTUP · RESET + CHORAL BENDA + PREPOSISI
...
Catatan Penting: Putaran kedua memakai frame "The ___ is ___ the ___.", bukan nama benda saja. Cukup dua posisi, tidak semua.
...
AKSI: Taruh buku di atas penghapus di meja guru.
...
Catatan Penting: Tunjukkan satu posisi tetap dan satu kalimat dengan struktur "The ___ is ___ the ___.". Jangan ganti posisi benda selama siswa menulis.
