...
| 1 | Pembuka · Hook Ekspresi Guru | Guru memancing minat lewat ekspresi wajahnya sendiri. |
| 2 | Inti · Listen First Gelombang 1 | Guru memperkenalkan empat emosi pertama. |
| 3 | Inti · Produksi Bersama Gelombang 1 + Contrast Drill | Guru memimpin produksi dan membedakan angry dengan scared. |
| 4 | Inti · Reactivation + Listen First Gelombang 2 | Guru meninjau gelombang 1 dan memperkenalkan tiga emosi berikutnya. |
| 5 | Inti · Produksi Gabungan Tujuh Emosi | Guru memimpin produksi tujuh emosi dalam tiga fase. |
| 6 | Inti · TPR "Show Me ..." | Guru memimpin retrieval lewat perintah berekspresi tanpa kartu. |
| 7 | Inti · Reset + Listen First Frame "I feel ... because ..." | Guru memodelkan pola "I feel ... because ...". |
| 8 | Inti · Produksi Bersama Kalimat Emosi | Guru memimpin produksi pola dengan model penuh lalu fill-in. |
| 9 | Inti · Whole-Class QA Drill + Demo Partner | Guru memimpin drill tanya jawab dan mendemokan latihan berpasangan. |
| 10 | Inti · Partner Practice | Guru memandu latihan berpasangan dengan skenario emosi. |
| 11 | Penutup · Reset + Choral Emosi + Kalimat | Guru memimpin choral emosi dengan frame penuh. |
...
## LAYAR 1 — PEMBUKA · HOOK EKSPRESI GURU
...
Catatan Penting: Guru yang berekspresi, bukan siswa. Cukup tiga ekspresi, jangan perkenalkan tujuh emosi di layar ini.
...
Catatan Penting: Bedakan angry dan scared lewat gestur tangan: angry mengepal, scared di pipi. Kelas belum diminta produksi di layar ini.
...
Catatan Penting: Contrast drill memasangkan angry dengan scared. Bedakan lewat gestur tangan, bukan ekspresi wajah saja.
...
AKSI: Buat ekspresi happy, sad, angry, dan scared berurutan.
UCAP: "Quick check."
...
Catatan Penting: Lakukan reactivation gelombang pertama tanpa mengoreksi. Bedakan tired dan bored lewat gestur: tired tangan ke dada, bored pipi bertumpu di tangan.

Darurat: —

---

## LAYAR 5 — INTI · PRODUKSI GABUNGAN TUJUH EMOSI
...
Catatan Penting: Jangan letakkan tired dan bored berurutan, dan jangan letakkan excited dan happy berurutan pada fase cepat. Pada fase cepat cukup tunjuk kartu tanpa membuat ekspresi penuh.
...
## LAYAR 7 — INTI · RESET + LISTEN FIRST FRAME "I FEEL ... BECAUSE ..."
...
Catatan Penting: Buat ekspresi dulu sebelum mengucapkan setiap kalimat. Pakai tangan kiri untuk feeling dan tangan kanan untuk because, konsisten sampai Layar 10.

Darurat: —

---

## LAYAR 8 — INTI · PRODUKSI BERSAMA KALIMAT EMOSI
...
Catatan Penting: Pertahankan urutan model penuh, ulang penuh, lalu fill-in. Pakai tangan kiri untuk feeling dan tangan kanan untuk because.
...
Catatan Penting: Lakukan QA drill dua putaran sebelum demo partner. Bisikkan skenario kepada siswa A, jangan ucapkan ke semua siswa.
...
AKSI: Biarkan siswa memilih ekspresi sendiri tanpa kartu.
...
Catatan Penting: Pertahankan peran tetap bersih: Partner A pemberi skenario dan penjawab, Partner B penanya. Jangan koreksi grammar saat berkeliling.
...
## LAYAR 11 — PENUTUP · RESET + CHORAL EMOSI + KALIMAT
...
Catatan Penting: Putaran kedua memakai frame "I feel ... because ...", bukan nama emosi saja. Cukup dua emosi, tidak semua tujuh.
...
Catatan Penting: Tahan ekspresi scared yang sama selama siswa menulis. Gunakan ekspresi scared, bukan happy.
