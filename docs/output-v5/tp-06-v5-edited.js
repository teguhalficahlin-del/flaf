  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        // L1 — PEMBUKA
        {
          ...
          bantuan: null,
          cue    : 'Gerakan tangan membentuk dilakukan bersamaan dengan menyebut nama — sebelum kartu dikeluarkan. Tunggu siswa bentuk tangan sendiri saat "what shape?" sebelum konfirmasi.',
          darurat: null,
          energi : '🟡',
        },
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tempel kartu di papan — dua batch. 👂 LISTEN FIRST — BATCH 1 AKSI: Bentuk tangan bulat — jeda 1 detik. UCAP: "Circle." AKSI: Bentuk tangan kotak — jeda 1 detik. UCAP: "Square." AKSI: Bentuk tangan segitiga — jeda 1 detik. UCAP: "Triangle." 🗣 TOGETHER → Siswa: "Circle! Square! Triangle!" --- UCAP: "Hands down." UCAP: "Look." AKSI: diam sejenak 3 detik. 👂 LISTEN FIRST — BATCH 2 AKSI: Bentuk tangan persegi panjang — jeda 1 detik. UCAP: "Rectangle." AKSI: Bentuk tangan bintang — jeda 1 detik. UCAP: "Star." AKSI: Bentuk tangan hati — jeda 1 detik. UCAP: "Heart." 🗣 TOGETHER → Siswa: "Rectangle! Star! Heart!" --- 🗣 FULL 6 UCAP: "All together!" → Siswa: "Circle! Square! Triangle! Rectangle! Star! Heart!" AKSI: Putaran kedua. UCAP: "Slow voice!"`,
          bantuan: [
            'Jika diam: bentuk tangan + ucap "Cir-..." menggantung → tunggu.',
            'Jika salah: bentuk tangan lebih jelas → model ulang.',
          ],
          cue    : 'Jeda 1 detik setelah setiap bentuk saat memberi contoh. Diam sejenak 3 detik antara BATCH 1 dan BATCH 2. Slow voice menjaga artikulasi lebih baik dari berbisik.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tunjuk kartu kiri ke kanan — satu putaran berurutan (mudah ditebak). UCAP: "What shape?" AKSI: Siswa jawab bersama. AKSI: Sebelum putaran kejutan: UCAP: "Hands on knees." UCAP: "Eyes ready." AKSI: Tenangkan 3 detik. UCAP: "Now, surprise cards!" AKSI: Tunjuk 4–5 kartu acak cepat. AKSI: Sesekali putar kartu atau ubah tinggi saat menunjuk.`,
        ...
        // L5 — INTI
        {
          ...
          bantuan: null,
          cue    : 'Gambar bentuk di udara sambil ucapkan instruksi — gerakan visual membantu pemahaman. Demo aturan dan demo permainan wajib dilakukan sebelum mulai.',
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Gambar bentuk perlahan — satu garis per detik. AKSI: Lakukan 4–5 bentuk saja. UCAP: "What is it?" AKSI: Siswa angkat tangan — jawab nama bentuk. AKSI: Sesekali berhenti — lihat kelas — pilih siswa — baru lanjut gambar. AKSI: Setelah selesai — tenangkan sebelum masuk Layar 7. UCAP: "Stand still." UCAP: "Deep breath." UCAP: "Sit nicely." AKSI: Tenangkan 5 detik.`,
          bantuan: [
            'Jika tidak ada yang menjawab: selesaikan gambar → bentuk tangan → tunggu.',
            'Jika kelas gaduh: "Hands up. Mouth closed." → tenangkan → lanjut.',
          ],
        ...
        // L8 — INTI
        {
          ...
          cue    : 'Tas harus ditutup dan diletakkan sebelum lanjut — fokus ke berbicara. Guru demo dulu sebelum siswa cari benda. Terima bentuk paling mirip untuk benda ambigu — jangan debat.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Show me your empty hands." UCAP: "Eyes here." UCAP: "Turn to your partner." UCAP: "Small voice." AKSI: Guru model volume kecil. --- AKSI: Contohkan pergantian 10 detik: A bicara. UCAP: "Switch." AKSI: B bicara. --- UCAP: "One turn each only." UCAP: "Show one thing. Say the shape. Switch." UCAP: "3... 2... 1... eyes here."`,
          bantuan: null,
          diferensiasi: {
          ...
          cue    : 'Contohkan pergantian A→B sebelum mulai. Aktivitas ini hanya 30–45 detik — jaga tempo.',
          darurat: null,
          energi : '🟡',
        },
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tunjuk benda di kelas — variasi pola respons dan tempo. AKSI: Lakukan 5–6 benda. Pola: cepat, cepat, jeda, cepat lagi. UCAP: "What shape?" AKSI: Siswa jawab lisan — cepat. UCAP: "Find rectangle!" AKSI: Siswa tunjuk — cepat. AKSI: Jeda 2 detik. UCAP: "Show me circle!" AKSI: Siswa tunjuk — lanjut.`,
          bantuan: 'Jika diam: bentuk tangan → ucap suku kata pertama → tunggu.',
          cue    : null,
          darurat: null,
          energi : '🟠',
        ...
        // L12 — PENUTUP
        {
          ...
          cue    : 'Ucapkan "Soft goodbye" dulu sebelum ucap bersama — atur volume penutup yang tenang.',
          darurat: null,
          energi : '🔵',
        },
