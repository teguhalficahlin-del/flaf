...
const TP_04 = {
  ...
  checklist: [
    ...
    'Jangan mulai Layar 1 sebelum kelas benar-benar tenang (preOpening)',
  ...
  catatan: {
    ...
    autonomy: [
      'Jika kelas sudah bisa hitung 1–10 tanpa jeda di putaran cepat L1, persingkat L3 dan fokus ke 11–20',
  ...
  preOpening: {
    tipe   : 'instruksi',
    teks   : `AKSI: Berdiri di depan kelas — cek benda hitung sudah siap di meja dalam jangkauan tangan. AKSI: Tunggu sampai semua siswa duduk tenang. UCAP: "Good morning, everyone! How are you today?" AKSI: Tunggu respons kelas. UCAP: "I'm fine, thank you!" UCAP: "Today — we count in English!" UCAP: "Are you ready?" AKSI: Jika kelas belum merespons: berdiri diam — ulangi "Are you ready?" sekali.`,
    bantuan: null,
    cue    : 'Layar ini pendek dan wajib. Jangan mulai tepuk dan hitung sebelum kelas tenang. Jika kelas belum fokus: ulangi "Are you ready?" sekali lagi sambil berdiri diam.',
    darurat: null,
    energi : '⚪',
  },
  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        // L1 — PEMBUKA
        {
          ...
          cue    : 'Langsung tunjuk jari tanpa penjelasan — gerakan mengundang keterlibatan naluriah. Beri 2 detik setelah "What comes next?" — jangan tunggu terlalu lama, jaga energi tetap mengalir. Angkat tangan sebagai transisi fisik singkat sebelum tepuk dan hitung.',
          darurat: null,
          energi : '🟠',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Great! You can count to ten!" UCAP: "Now let us learn the numbers — with cards!" AKSI: Ambil kartu 1 dari tumpukan kartu.`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '⚪',
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tempel kartu 1–10 di papan satu per satu sambil ucapkan. AKSI: Minta siswa mendengarkan terlebih dahulu tanpa mengikuti. UCAP: "One. Two. Three. Four. Five. Six. Seven. Eight. Nine. Ten." AKSI: Ajak seluruh kelas mengucapkan bersama. UCAP: "Now say it with me!" AKSI: Tunjuk kartu satu per satu. → Siswa: "One! Two! Three! Four! Five! Six! Seven! Eight! Nine! Ten!" AKSI: Putaran kedua — suara bisik: "Whisper voice!" → Siswa ucap semua angka dengan suara bisik.`,
          bantuan: [
          ...
          cue    : 'Guru ucapkan sendiri dulu sebelum siswa ikut. Suara bisik menjaga bentuk bunyi asli lebih baik dari suara datar/robot — satu putaran singkat saja.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Angkat kartu "10" setinggi dada, hadapkan ke kelas — minta kelas mengucapkan. UCAP: "Ten!" UCAP: "Good." UCAP: "Now what comes after ten?" UCAP: "These numbers sound different." UCAP: "Just listen first — no need to repeat yet." AKSI: Mulai tempel kartu 11–20 satu per satu sambil ucapkan setiap angka dengan pelan. → "Eleven. Twelve. Thirteen. Fourteen. Fifteen. Sixteen. Seventeen. Eighteen. Nineteen. Twenty."`,
          bantuan: null,
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Angkat kartu 11–20 satu per satu setinggi dada, hadapkan ke kelas. AKSI: Minta siswa mendengarkan Bagian 1 terlebih dahulu tanpa mengikuti. UCAP: "Eleven. Twelve. Thirteen. Fourteen. Fifteen." UCAP: "Good listening!" AKSI: Minta siswa mendengarkan Bagian 2 terlebih dahulu tanpa mengikuti. UCAP: "Sixteen. Seventeen. Eighteen. Nineteen. Twenty." AKSI: Tiru bertahap satu putaran — ucap satu angka, jeda, siswa ikut. → "Eleven..." [siswa ikut] → "Twelve..." [siswa ikut] → dst sampai fifteen. → "Sixteen..." [siswa ikut] → dst sampai twenty. AKSI: Ucapkan bersama kelas sekali lagi — semua angka 11–20 tanpa jeda tiru bertahap, tidak perlu cepat.`,
          bantuan: [
            'Jika siswa diam: ucapkan bersama guru — jangan koreksi individual.',
            'Jika kelas kuat: lewati tiru bertahap, langsung satu rangkaian penuh.',
          ],
          cue    : 'Ucapkan Bagian 1 pelan — fonologi 11–15 sangat berbeda. Jangan terlalu lama di tiru bertahap — tempo runtuh jika terlalu banyak bantuan. Fokus ke paparan, bukan akurasi.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Angkat kartu angka secara acak setinggi dada, hadapkan ke kelas — minta siswa menyebutkan angkanya. AKSI: Lakukan 5–6 ronde individual — angkat kartu, siswa angkat tangan lalu jawab. UCAP: "What number? Fast!" UCAP: "Look carefully... what number?" AKSI: Selingi 1–2 ronde seluruh kelas di antara ronde individual. UCAP: "Everyone together — what number?"`,
          bantuan: [
            'Jika tidak ada yang menjawab: ucap suku kata pertama "Thir-..." → tunggu.',
            'Jika kelas gaduh: "Freeze. Hands down. Eyes here." → tenangkan → lanjut.',
          ],
          cue    : 'Jangan pakai "Fast!" untuk belasan — target masih pengenalan stabil, bukan kecepatan. Ronde seluruh kelas menjaga partisipasi merata — siswa lambat tetap dapat kesempatan mendengar.',
          darurat: null,
          energi : '🔴',
        },
        ...
        // L8 — INTI
        {
          ...
          cue    : 'Semua benda harus sudah dalam jangkauan di meja guru — ambil langsung tanpa cari-cari. Bahas benda sebentar — kembali ke menghitung cepat. Variasikan jumlah benda — jangan semua 10. Target utama adalah angka; "There are..." adalah bonus yang guru contohkan saja.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Beri sinyal perubahan mode. UCAP: "Partner voice." UCAP: "Now practise with your partner." UCAP: "Count with your fingers." UCAP: "Stay in your seat." UCAP: "Partner A counts first." UCAP: "Partner B listens." UCAP: "Then switch."`,
          bantuan: null,
          diferensiasi: {
            needHelp: 'Fokus angka 1–10 saja — hitung benda di meja sendiri — guru bantu tunjuk dan hitung bersama.',
            ready   : 'Gunakan 11–20 jika bisa — hitung benda di sekitar kursi — guru contohkan "There are [n] [benda]" jika siswa siap ikuti.',
          },
          cue    : 'Ucapkan "Partner voice" sebelum mulai — isyarat volume suara cegah kegaduhan meningkat.',
          darurat: null,
          energi : '🟡',
        },
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Angkat telapak tangan menghadap atas. UCAP: "Everyone, stand up!" AKSI: Tunggu sampai semua berdiri. AKSI: Tentukan kelompok dengan penunjukan fisik: → Guru berjalan ke area kiri → sentuh → "Group 1, here." → Guru ke tengah → sentuh → "Group 2, here." → Guru ke kanan → sentuh → "Group 3, here." AKSI: Lanjut subdivisi jika kelas besar. UCAP: "I count down from ten. When I call your group, sit down!" AKSI: Demo: UCAP: "Watch. Group 1, ten!" AKSI: Kelompok 1 duduk. UCAP: "Good. Like that. Everyone stand again!"`,
          bantuan: null,
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Jika siswa sudah berdiri dari demo L10: langsung mulai. Jika sudah duduk: angkat telapak tangan → UCAP: "Stand up, everyone." → tunggu semua berdiri. AKSI: Mulai hitung mundur. AKSI: Kelompok kecil per angka — ritme tetap jalan sampai "One!" UCAP: "Ten!" AKSI: Kelompok 1 duduk. UCAP: "Nine!" AKSI: Kelompok 2 duduk. UCAP: "Eight!" AKSI: Kelompok 3 duduk. AKSI: Terus dengan subdivisi sampai semua duduk. UCAP: "One!" UCAP: "Blast off!" 🚀 AKSI: Semua angkat tangan sambil tetap duduk.`,
          bantuan: null,
          cue    : 'Siswa tetap duduk saat "Blast off!" — cegah kelas kembali ramai sebelum refleksi. Jaga ritme cepat — jangan tunggu kesempurnaan.',
          darurat: null,
          energi : '🔴',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Kumpulkan kartu angka 1–20. AKSI: Simpan benda yang dipakai untuk menghitung. AKSI: Catat siswa yang: - kesulitan angka 11–19, - tidak bisa menjawab "How many?", - atau tidak ikut tepuk dan hitung.`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '🔵',
