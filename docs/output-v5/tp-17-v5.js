 ...
 * File: tp-17-v5.js
 * Format: v5.0
 * Source: flaf-skenario-tp17-v2.txt
...
const TP_17 = {
  ...
  catatan: {
    risiko: [
      ...
      'Fase C: swimming dan cycling tidak boleh berurutan — interference tinggi',
    ],
    autonomy: [
  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Guru berdiri di tengah kelas. Tidak ada kartu dulu. → Guru gesture membuka buku, pura-pura membaca: "I like reading!" [Tunggu 2–3 detik — biarkan kelas observe] → Guru gesture mengaduk masakan: "I like cooking!" [Tunggu 2–3 detik] → Guru gesture menendang bola: "I like playing football!" [Tunggu 2–3 detik] UCAP: "These are hobbies. Things we love to do. Today — hobbies in English." [Tunggu respons bebas — tidak dikoreksi, tidak dikonfirmasi]`,
          bantuan: null,
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `👂 LISTEN FIRST AKSI: Tempel 4 kartu satu per satu: reading — drawing — singing — dancing Setiap kartu: tunjuk kartu → buat gesture → ucap gerund. Satu detik jeda, lanjut. UCAP: "Listen. My turn." → "Reading." [gesture membuka buku, mata ke bawah — tunjuk kartu] → "Drawing." [gesture pegang pensil, gambar di udara — tunjuk kartu] → "Singing." [gesture tangan ke mulut, kepala sedikit naik — tunjuk kartu] → "Dancing." [gesture gerak badan kiri kanan — tunjuk kartu] "One more time." → ulang sekali.`,
          bantuan: null,
        ...
        {
          tipe   : 'instruksi',
          teks   : `🗣 TOGETHER UCAP: "Now together. I show — you say." → Gesture membuka buku: kelas ucap "Reading!" → Gesture pensil di udara: "Drawing!" → Gesture tangan ke mulut: "Singing!" → Gesture gerak badan: "Dancing!" Putaran 2: guru tunjuk 2 kartu acak — kelas ucap. Contrast drill — langsung setelah putaran 2 (15 detik): UCAP: "Watch." → Gesture reading — mata ke bawah, tangan diam: "Reading — hands still." → Gesture drawing — tangan bergerak di udara: "Drawing — hands move." "Ready? Which one?" → "Hands still — show me!" → kelas gesture reading → "Hands move — show me!" → kelas gesture drawing → Ulangi 2 putaran, cepat.`,
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI — Reactivation (15–20 detik): "Quick check." → Guru gesture 4 hobi gelombang 1 berurutan — kelas ucap. → Tidak dikoreksi. Tidak diulang. Langsung lanjut. 👂 LISTEN FIRST Gelombang 2 AKSI: Tempel 4 kartu berikutnya: playing football — cooking — swimming — cycling Setiap kartu: tunjuk kartu → gesture → ucap gerund. "Listen. My turn." → "Playing football." [gesture menendang bola — tunjuk kartu] → "Cooking." [gesture mengaduk panci — tunjuk kartu] → "Swimming." [gesture lengan berenang ke samping — tunjuk kartu] → "Cycling." [gesture pegang setir + kaki mengayuh — tunjuk kartu] "One more time." → ulang sekali.`,
        ...
        {
          tipe   : 'instruksi',
          teks   : `🗣 TOGETHER Fase A — Gelombang 2 saja, lambat: "Together." → Gesture menendang: "Playing football!" → Gesture mengaduk: "Cooking!" → Gesture lengan ke samping: "Swimming!" → Gesture pegang setir: "Cycling!" Fase B — Campur 8 kartu, medium: "Now — all together." → Tunjuk semua 8 kartu berurutan — medium speed. Kelas ucap. Fase C — 4 kartu acak, cepat: "Ready? Fast — but clear." → Pilih 4 kartu acak. Tahan 1 detik sebelum lanjut. → Jika energi kelas naik liar setelah Fase B: langsung masuk Fase C tanpa ulang. Contrast drill swimming vs cycling — langsung setelah Fase C (15 detik): → Jika energi turun setelah Fase C: langsung masuk contrast drill tanpa repeat tambahan. UCAP: "Watch." → Gesture swimming — kedua lengan ke samping: "Swimming — arms out." → Gesture cycling — tangan setir + kaki: "Cycling — hands and feet." "Which one? Arms out — show me!" → kelas gesture swimming. "Hands and feet — show me!" → kelas gesture cycling. Ulangi 2 putaran, cepat.`,
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Guru lepas semua kartu dari papan — simpan. Siswa tidak pegang apa-apa. UCAP: "No cards. Just me and you." → "Show me reading!" → kelas gesture reading → "Show me drawing!" → kelas gesture drawing → "Show me singing!" → kelas gesture singing → "Show me dancing!" → kelas gesture dancing → "Show me playing football!" → kelas gesture menendang → "Show me cooking!" → kelas gesture mengaduk → "Show me swimming!" → kelas gesture lengan → "Show me cycling!" → kelas gesture setir + kaki Putaran acak — maksimal 5 cue. Guru tidak ikut — kelas yang aksi. UCAP: "My turn to watch. You show me." → Pilih 5 cue acak. Pisahkan pasangan mirip — reading/drawing tidak berurutan, swimming/cycling tidak berurutan. → Setelah 5 cue: langsung stop. UCAP: "Stop. Good." [Tepuk 1 kali — freeze] UCAP: "Sit down. Hands down." [Jeda 3 detik]`,
          bantuan: 'Jika kelas tertukar swimming/cycling: guru berdiri diam — gesture swimming (lengan) → gesture cycling (setir + kaki). Lanjut.',
        ...
        {
          tipe   : 'instruksi',
          teks   : `🗣 TOGETHER UCAP: "Together now. Whole sentence." Tunjuk papan: I like ___ because it is ___. Pattern setiap giliran: guru model penuh → kelas ulang penuh → baru fill-in. Giliran 1: → Gesture reading. → Guru: "I like reading because it is interesting." → Kelas ulang penuh: "I like reading because it is interesting." Giliran 2: → Gesture singing. → Guru: "I like singing because it is…" [tangan buka — tunggu] → Kelas isi: "…fun!" → Kelas ulang penuh: "I like singing because it is fun." Giliran 3: → Gesture playing football. → Guru: "I like playing football because it is…" [tangan buka — tunggu] → Kelas isi: "…fun!" → Kelas ulang penuh: "I like playing football because it is fun." Giliran 4: → Gesture swimming. → Guru: "I like swimming because it is…" [tangan buka — tunggu] → Kelas isi: "…interesting!" → Kelas ulang penuh: "I like swimming because it is interesting."`,
        ...
        {
          tipe   : 'instruksi',
          teks   : `"Together — hobbies." Putaran 1: tempel kembali semua 8 kartu — tunjuk berurutan — lambat — kelas ucap nama hobi. → Tahan 1 detik sebelum tunjuk kartu berikutnya — jangan biarkan kelas chant otomatis. Putaran 2: guru gesture reading — kelas ucap frame penuh: "I like reading because it is interesting!" → Gesture dancing: "I like dancing because it is fun!" Cukup 2 hobi — tidak semua.`,
          bantuan: null,
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Take your pencil." [Tunggu — pastikan semua siswa sudah pegang pensil] AKSI: Guru gesture cycling — tahan posisi. Tunjuk papan. UCAP: "Last. Write one sentence." → "I like ___ because it is ___." → "Look at my gesture." [tahan gesture cycling] [Tunggu 45–60 detik] "Show me."`,
          bantuan: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI — Retrieval mikro: "One more time — show me reading!" → Kelas gesture reading + ucap "Reading!" "Show me dancing!" → Kelas gesture dancing + ucap "Dancing!" AKSI: Tunjuk semua 8 kartu cepat — kelas ucap nama hobi bersama. UCAP: "Today — hobbies. Reading, drawing, singing, dancing, playing football, cooking, swimming, cycling. And we say: I like ___ because it is fun or interesting. Well done. See you next time."`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '🔵',
