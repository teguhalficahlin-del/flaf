...
const TP_08 = {
  ...
  preOpening: {
    ...
    bantuan: null,
    cue    : 'Jangan tunjukkan kartu denah sebelum Layar 2. Nada tenang dijaga dari sini. Jika kelas belum fokus: ulangi "Are you ready?" sambil berdiri diam.',
    darurat: null,
    energi : '🔵',
  },
  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Ambil kartu floor plan dari meja. Tunjukkan ke kelas dengan dua tangan. UCAP: "Look — this is a house. It has rooms." 👂 LISTEN FIRST — tunjuk tiap kotak di denah satu per satu: UCAP: "Bedroom. Kitchen." ⚡ jeda singkat 2–3 detik. UCAP: "Bathroom." "Living room." [gerakan: dua tangan membuka lebar — seperti menunjuk ruang santai] → Kelas menyimak dulu — belum diminta ulang.`,
          bantuan: null,
          cue    : 'Gerakan "living room" dilakukan saat menyebut — bukan sesudah. Jeda singkat antara bedroom/kitchen → bathroom/living room wajib.',
          darurat: null,
          energi : '🔵',
        },
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tempel 4 kartu ruangan di papan: bedroom · kitchen · bathroom · living room. 🗣 TOGETHER — tunjuk satu per satu, kelas echo: "Bedroom! Kitchen! Bathroom! Living room!" ⚡ MINI CONTRAST CHECK sebelum putaran acak: Tunjuk bedroom → "Bed-room." Tunjuk bathroom → "Bath-room." → Kelas ulang pelan. Bedakan dulu sebelum pengambilan cepat. 🔁 Putaran acak — tunjuk kartu, kelas sebutkan. ⚡ Putaran pertama lambat dulu — baru putaran kedua lebih cepat.`,
          bantuan: 'Bathroom/bedroom masih tertukar: tunjuk dua kartu berdampingan → "Bath-room. Bed-room. Different!"',
          cue    : 'Contrast check bedroom vs bathroom wajib sebelum putaran acak. Putaran pertama lambat — jangan langsung cepat.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tutup label kartu. Tunjuk gambar saja. UCAP: "What room is this?"
---
AKSI: Sebelum putaran cepat: → "Hands on knees." → "Eyes ready." Gerakan: tunjuk mata → tunjuk kartu → kelas jawab. → "Wait... look... answer!" → Kelas sebutkan serentak. 2–3 putaran acak. UCAP: "Fast round — go!" ⚡ Tahan kartu 1 detik penuh sebelum menunjuk kelas. Kelas 1 impulsif sering menjawab dari tebakan visual awal — tahan dulu. ⚡ Sengaja tunjuk bedroom → bathroom → bedroom berurutan dua kali. Pembedaan diperkuat saat mengingat, bukan hanya saat echo.
---
⚡ Sesekali tunjuk 1 siswa cepat — "What room?" — ambil contoh per individu.`,
          bantuan: 'Jika masih tertukar: kembali ke contrast check sebentar → "Bath-room. Bed-room." → lanjut putaran cepat.',
          cue    : '"Hands on knees. Eyes ready." sebelum putaran cepat — jangan langsung tunjuk kartu. Bedroom → bathroom → bedroom = wajib masuk urutan.',
          darurat: null,
          energi : '🟠',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Good. Hands down. Take a breath."
AKSI: Tarik napas bersama.
UCAP: "Now — what is INSIDE the rooms? Watch." ⚡ Gerakan konkret: tunjuk kotak ruangan di kartu denah → lalu tunjuk gambar benda di dalamnya. Hubungan visual dulu sebelum vocab benda.`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '⚪',
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tunjuk kartu bedroom. UCAP: "Bedroom — bed." 🗣 TOGETHER: "Bed!" AKSI: Tunjuk kartu kitchen. UCAP: "Kitchen — table." 🗣 TOGETHER: "Table!" AKSI: Tunjuk kartu living room. UCAP: "Living room — sofa."
AKSI: Lakukan gerakan duduk santai sekali.
🗣 TOGETHER: "Sofa!" ⚡ Repetisi gerakan "sofa/living room" lintas layar membantu daya ingat tanpa aktivitas baru. AKSI: Tunjuk kartu bathroom. UCAP: "Bathroom — shower."
AKSI: Lakukan gerakan mandi cepat.
🗣 TOGETHER: "Shower."`,
          bantuan: null,
          cue    : 'Gerakan untuk "sofa" dan "shower" dilakukan bersamaan dengan menyebut kata — bukan sesudah. Mini echo sekali saja per benda.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tunjuk kartu bedroom. UCAP: "Bedroom." → kelas: "Bedroom." "Bed." → kelas: "Bed." UCAP: "There is..." [tunjuk kartu] "a bed..." [tunjuk gambar kasur] "in the bedroom." [tunjuk kartu ruangan] 🗣 TOGETHER: "There is a bed in the bedroom." UCAP: "Good." ⚡ Jeda 2 detik. jeda memproses sebelum model kedua. AKSI: Ganti kartu kitchen. UCAP: "There is..." [tunjuk] "a table..." [tunjuk meja] "in the kitchen." [tunjuk kartu dapur] 🗣 TOGETHER: "There is a table in the kitchen."`,
          bantuan: null,
          cue    : 'Gerakan per bagian wajib — tunjuk benda dulu, tunjuk ruangan kemudian. Kalimat terasa dibangun, bukan dihapalkan. Jeda 2 detik antara model pertama dan kedua.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Ambil kartu living room. Pegang — contohkan sekali: "There is a sofa in the living room."
---
AKSI: Berikan kartu bathroom ke 1 siswa sukarela. UCAP: "Listen first." "Loud enough for your friends." "Say: There is a shower in the bathroom." ⚡ Pilihkan benda secara eksplisit — jangan beri pilihan terbuka. Tujuan demo adalah mekanisme, bukan kreativitas. → Siswa: "There is a shower in the bathroom." ⚡ Saat siswa sukarela bicara — guru tetap memperagakan gerakan: tunjuk benda → tunjuk ruangan. Perhatian kelas ke struktur kalimat, bukan ke siapa yang maju.
---
UCAP: "Two claps for your friend!" ⚡ Tepuk-tepuk — selesai. Langsung lanjut.`,
          bantuan: null,
          cue    : 'Demo tiga langkah: pegang → tunjuk → ucap. Guru tetap memperagakan gerakan selama siswa sukarela bicara.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: DISTRIBUSI DULU — dalam diam: "Hands still. Wait." Bagikan 2 kartu ruangan acak per pasangan. Tunggu semua kartu sampai.
---
...
---
⚡ Aturan penerimaan: pasangan yang hanya bilang "Bed — bedroom!" tetap diterima sementara. Guru model ulang saat lewat tanpa menghentikan flow: Siswa: "Bed — bedroom." Guru: "Yes! There is a bed in the bedroom." → lanjut jalan. ⚡ Bantuan sebagian — hanya setelah jeda 2–3 detik atau pasangan benar-benar freeze: Guru: "There is a..." → siswa isi. Jangan terlalu cepat membantu. ⚡ Contohkan volume: keras ❌ → pelan ❌ → suara berpasangan ✅ ⚡ Isyarat berhenti: Tepuk 1 kali → "Freeze. Eyes here." "3... 2... 1... hands down."`,
          bantuan: 'Pasangan diam/freeze: guru pegang kartu, ucap "There is a..." → tunggu 2–3 detik → siswa isi → guru lanjut jalan.',
          cue    : 'Distribusi kartu diam dulu, instruksi belakangan — bukan bersamaan. Aturan penerimaan berlaku — koreksi saat lewat, bukan berhenti.',
          darurat: 'Waktu ≤12 menit: lewati ke Layar 11.',
          energi : '🟠',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Pilih tingkat sesuai kemampuan siswa.
→ Belum bisa: sebutkan nama ruangan saja.
→ Sebagian besar siswa: gunakan tingkat Normal.
→ Siswa yang cepat selesai: gunakan tingkat Tantangan.
Belum bisa → Sebutkan nama ruangan saja: "Bedroom. Kitchen." Normal → "There is a bed in the bedroom." Tantangan → "In my bedroom, there is a bed and a lamp." ⚡ Contoh kalimat tantangan di SISI papan — tidak dibacakan keras, tidak dimodelkan seluruh kelas. Untuk mayoritas kelas 1 biasa, perluasan ini bonus murni — tidak perlu merasa harus tersentuh.
AKSI: Setelah latihan selesai, ucapkan "Cards down. Eyes here." Lanjut ke Layar 11.`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '🟡',
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Cards down." ⚡ Tunggu 2 detik — baru siswa sukarela mulai. Benda di tangan = pengalih perhatian.
---
AKSI: Tunjuk langsung 2–3 siswa: "You, you." — jangan buka sesi tanya siapa mau maju. ⚡ Sesekali pilih siswa percaya diri sedang, bukan selalu yang paling aktif. UCAP: "Show your card. Tell us one sentence." → Siswa: "There is a bed in the bedroom." UCAP: "Thumbs up for your friend!"
---
⚡ jeda tenang singkat setelah presentasi terakhir: "Hands down. Take a breath. Sit nicely." — 5 detik.`,
          bantuan: [
            'Jika siswa sukarela freeze: guru whisper "There is a..." — jaga momentum tanpa buat siswa tertekan.',
            'Jika tidak ada yang siap: tunjuk 2 siswa bersama — ucapkan serentak.',
          ],
          cue    : '"Cards down." + tunggu 2 detik sebelum siswa sukarela mulai. Tunjuk langsung — jangan buka sesi tanya.',
          darurat: null,
          energi : '🔴',
        },
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tunjuk kartu ruangan di papan — label tertutup. UCAP: "What room?" → Kelas sebutkan serentak. ⚡ Fleksibilitas pelaksanaan: Jika kelas masih segar → 4 kartu pengambilan + 1 sentence bebas. Jika kelas lelah → cukup 2 kartu, lanjut ucap bersama dipimpin guru sekali: Guru: "There is a bed..." → kelas: "...in the bedroom." Lalu siswa isi penuh sekali lagi — tetap ada rasa "kami bisa". UCAP: "Good job." ⚡ Senyum. Jeda 2 detik.
---
AKSI: Tunjuk 1 kartu saja. UCAP: "One sentence. There is a ___ in the ___. Go!" → Siswa serentak — satu kartu yang sama.`,
          bantuan: null,
          cue    : 'Satu kartu = output terkontrol. Tidak gaduh, tidak pecah. Jeda 2 detik antara pengambilan dan sentence — jangan tergesa.',
          darurat: null,
          energi : '🟡',
        },
