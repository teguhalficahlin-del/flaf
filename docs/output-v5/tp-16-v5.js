 ...
 * File: tp-16-v5.js
 * Format: v5.0
 * Source: flaf-skenario-tp16-v2.txt
  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Guru pegang buku cerita — tunjuk sampul ke kelas. Jangan buka halaman dalam dulu. UCAP: "Look at this. What do you see?" [Tunggu 2–3 respons bebas — boleh Bahasa Indonesia] UCAP: "Who is in the picture?" [Tunggu 2–3 respons] UCAP: "What do you think will happen in this story?" [Tunggu 2–3 prediksi — tidak dikoreksi, tidak dikonfirmasi] UCAP: "Let's find out. Listen carefully."`,
          bantuan: null,
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Guru pegang buku terbuka di halaman relevant saat tanya. "Now — questions." → Tunjuk gambar Ani — minta siswa tunjuk Ani juga: "Point to Ani!" [kelas tunjuk] "Who is the main character?" → Kelas: "Ani!" / "The girl!" → Tunjuk gambar kucing — minta siswa tunjuk kucing: "Point to the cat!" [kelas tunjuk] "What did she find in the park?" → Kelas: "A cat!" → Tunjuk halaman ending: "Where did they find the cat's home?" → Kelas: jawaban apapun yang masuk akal — diterima. UCAP: "Good. You understand the story."`,
          bantuan: null,
          cue    : '"Point to ___!" sebelum setiap pertanyaan — micro movement ini membantu perhatian kelas 1 yang sudah tiga layar berturut-turut dalam mode focused. Guru selalu tunjuk halaman relevant sebelum tanya. Terima jawaban Bahasa Indonesia dan campuran. Tiga pertanyaan cukup — tidak lebih.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `👂 LISTEN FIRST AKSI: Simpan buku cerita. Tunjuk papan — First · Then · After that · Finally "Listen. Four magic words." → Tunjuk "First" — tangan kiri ke posisi paling kiri, gesture jalan: "First." [spatial: paling kiri] → Tunjuk "Then" — tangan geser satu langkah ke kanan, gesture terkejut: "Then." [spatial: satu langkah maju] → Tunjuk "After that" — tangan geser satu langkah lagi ke kanan, gesture memberi makan: "After that." [spatial: dua langkah maju] → Tunjuk "Finally" — tangan geser ke posisi paling kanan, buka lebar: "Finally." [spatial: paling kanan, paling jauh] "One more time." → ulang sekali, lambat.`,
          bantuan: null,
          cue    : 'Gesture dua lapis konsisten sepanjang L4–L11: spatial (posisi tangan kiri ke kanan) + aksi cerita (jalan, terkejut, memberi makan, buka lebar). Dua layer ini harus selalu muncul bersama — spatial saja tidak cukup untuk kelas 1. "After that" dua kata — ucap pelan, tidak terburu. Guru belum minta kelas produksi di layar ini.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `🗣 TOGETHER Fase A — Produksi vocab, lambat: "Together." → Tunjuk papan: "First!" → kelas ucap "First!" → "Then!" → "Then!" → "After that!" → "After that!" → "Finally!" → "Finally!" Ulangi sekali lagi, medium speed. Fase B — Apply ke cerita: "Now — the story." → Tunjuk "First" di papan — tangan kiri posisi paling kiri, gesture jalan: → Guru: "First — Ani walked in the park." → Kelas ulang: "First — Ani walked in the park." → Tunjuk "Then" — tangan satu langkah ke kanan, gesture terkejut: → Guru: "Then — she found a cat." → Kelas ulang: "Then — she found a cat." → Tunjuk "After that" — tangan dua langkah ke kanan, gesture memberi makan: → Guru: "After that — she helped the cat." → Kelas ulang: "After that — she helped the cat." → Tunjuk "Finally" — tangan paling kanan, buka lebar: → Guru: "Finally — they found the home!" → Kelas ulang: "Finally — they found the home!"`,
          bantuan: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Guru tutup/hapus papan. Siswa tidak pegang apa-apa. UCAP: "No board. Just me and you." → Guru: tangan kiri posisi paling kiri + gesture jalan: "What word?" → Kelas: "First!" → Guru: tangan satu langkah ke kanan + gesture terkejut: "What word?" → Kelas: "Then!" → Guru: tangan dua langkah ke kanan + gesture memberi makan: "What word?" → Kelas: "After that!" → Guru: tangan paling kanan + buka lebar: "What word?" → Kelas: "Finally!" Putaran acak — maksimal 4 gesture. Guru tidak ucap kata — kelas yang produksi. UCAP: "Stop. Good." [Tepuk 1 kali — freeze] UCAP: "Sit down. Hands down." [Jeda 3 detik]`,
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Watch. I show you first." AKSI: Guru pegang set kartu urutan. Pilih 1 siswa sukarela sebagai Listener — siswa ini pegang set kartu mereka sendiri. Demo: → Guru angkat kartu "First" + gesture jalan: "First — Ani walked in the park." → Siswa Listener angkat kartu "First" — tahan. → Guru angkat kartu "Then" + gesture terkejut: "Then — she found a cat." → Siswa Listener angkat kartu "Then." → Guru angkat kartu "After that" + gesture memberi makan: "After that — she helped the cat." → Siswa Listener angkat kartu "After that." → Guru angkat kartu "Finally" + buka lebar: "Finally — they found the home!" → Siswa Listener angkat kartu "Finally." UCAP: "Storyteller tells. Listener holds the card. Raise when you hear the word." Sebelum practice: "Partner voice — not shouting." Latih stop signal: "When I clap —" [tepuk 1 kali] "— stop." — latih 1x. UCAP: "Partner A tells the story. Partner B holds cards. Go."`,
          bantuan: null,
        ...
        // L10 — INTI
        {
          ...
          cue    : 'Reflection ini observasional — guru sebut fakta cerita, bukan interpretasi moral. Hindari kalimat seperti "when we help someone we feel good inside" — terlalu abstrak untuk kelas 1 dan berisiko jadi ceramah. Guru yang bicara, bukan kelas. Tidak ada tangan angkat, tidak ada sharing wajib. Diam 5 detik wajib — jangan tanya apa-apa selama jeda. Maksimal 2 menit total.',
          darurat: null,
          energi : '⚪ → 🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "One more time — together." → Buka papan kembali: "First!" → kelas: "First!" "Then!" → kelas: "Then!" "After that!" → kelas: "After that!" "Finally!" → kelas: "Finally!" → Guru tunjuk kartu satu per satu acak — kelas ucap nama. Maksimal 5 kartu acak — tahan 1 detik sebelum lanjut. "And the story — fast." → Tangan kiri posisi paling kiri + gesture jalan: kelas ucap "First — Ani walked!" → Tangan satu langkah kanan + gesture terkejut: "Then — she found a cat!" → Tangan dua langkah kanan + gesture memberi makan: "After that — she helped!" → Tangan paling kanan + buka lebar: "Finally — they found the home!"`,
          bantuan: null,
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Take your pencil." [Tunggu — pastikan semua siswa sudah pegang pensil] AKSI: Guru tunjuk kartu "Then" — tahan di depan kelas. UCAP: "Write one sentence. Use this word." [tunjuk kartu "Then"] → "Then — ___________." → "Tell me about the story." [Tunggu 45–60 detik] "Show me."`,
          bantuan: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI — Retrieval mikro: "One more time — all four words." → Tunjuk kartu satu per satu: kelas ucap. "First! Then! After that! Finally!" UCAP: "Today — we listened to a story. We used four words: first, then, after that, finally. You are great storytellers. See you next time."`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '🔵',
