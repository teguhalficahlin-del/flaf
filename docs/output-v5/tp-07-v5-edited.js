...
const TP_07 = {
  ...
  preOpening: {
    ...
    bantuan: null,
    cue    : 'Nada tenang dijaga dari sini — TP 07 bertumpu pada koneksi personal. Jangan tergesa masuk ke Layar 1. Jika kelas belum fokus: ulangi "Are you ready?" sambil berdiri diam.',
    darurat: null,
    energi : '🔵',
  },
  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        // L2 — PEMBUKA
        {
          ...
          bantuan: null,
          cue    : 'Kalimat terakhir adalah sentuhan emosi — ucapkan hangat, tidak perlu tekanan intonasi besar. Dua kartu saja di Layar ini — jangan tempel dulu.',
          darurat: null,
          energi : '🔵',
        },
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tempel 2 kartu tambahan: grandmother · grandfather. UCAP: "Listen first — Grandmother." [jeda 2 detik] "Grandfather." 🗣 TOGETHER — Tiru bertahap suku kata: "Grand— ... mother!" → kelas ikut "Grand— ... father!" → kelas ikut --- ⚡ MINI DISCRIMINATION CHECK: Tunjuk kartu cepat — "Grandmother?" → tunjuk kartu lain — "Grandfather?" ⚡ Putaran kedua — opsi separuh kelas: Sisi kiri → "Grandmother" Sisi kanan → "Grandfather" Bantu kejelasan tanpa semua serentak. --- AKSI: Tunjuk semua 6 kartu acak — kelas sebutkan bersama 2 putaran.`,
          bantuan: 'Masih tertukar: ulang tiru bertahap "Grand—..." sekali lagi sebelum lanjut.',
          cue    : 'Tiru bertahap "Grand—..." penting untuk grandmother/grandfather — jangan lewati. Cek pembeda wajib sebelum masuk Layar 5.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tutup label kartu. Tunjuk gambar saja. UCAP: "What is this?" → Kelas sebutkan serentak. ⚡ Acak urutan — bukan urutan tempel. --- AKSI: Sebelum putaran cepat: → "Hands on knees." → "Eyes ready." Gesture: tunjuk mata dulu → baru tangan ke kartu. → "Wait... look... answer!" --- UCAP: "Fast!" — percepat 2–3 putaran terakhir.`,
          bantuan: 'Jika diam: buka label setengah → kelas bantu → tutup lagi → coba ulang.',
          cue    : '"Hands on knees. Eyes ready." sebelum putaran cepat — jangan langsung tunjuk kartu.',
          darurat: null,
          energi : '🟠',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Okay — hands down. Take a breath." AKSI: Tarik napas bersama. UCAP: "Now — we make sentences. Watch me first." ⚡ jeda tenang 15 detik sebelum produksi kalimat.`,
          bantuan: null,
          cue    : null,
          darurat: null,
          energi : '⚪',
        ...
        // L7 — INTI
        {
          ...
          bantuan: null,
          cue    : 'Vocab dulu → baru kalimat. Jangan langsung contohkan kalimat penuh — bangun bertahap agar kelas merasakan strukturnya.',
          darurat: null,
          energi : '🟡',
        },
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Ambil kartu grandfather. Pegang — contohkan sekali: "This is my grandfather." AKSI: Berikan kartu ke 1 siswa sukarela. UCAP: "Hold. Show. Say it." → Siswa: "This is my grandfather." UCAP: "Two claps for your friend!" ⚡ Tepuk-tepuk — selesai. Langsung lanjut.`,
          bantuan: null,
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: DISTRIBUSI DULU — dalam diam. UCAP: "Hands still." UCAP: "Wait." AKSI: Bagikan 2–3 kartu printable acak per pasangan (bukan full set). Tunggu semua kartu sampai. --- AKSI: Baru instruksi: "Partner A — pick one card. Show. Say: 'This is my ___.' Partner B — listen. Then switch." "Three cards each. Go!" "Finished? Do it again — faster!" --- ⚡ Contohkan volume: Guru demo terlalu keras ❌ → terlalu pelan ❌ → suara untuk berpasangan ✅ --- ⚡ Guru jalan keliling. Koreksi hanya jika vocab salah total. ⚡ Isyarat berhenti: Tepuk 1 kali → "Freeze. Eyes here." Baru: "3... 2... 1... hands down."`,
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Cards down. Eyes here." AKSI: Panggil 2–3 siswa sukarela maju. Pegang kartu pilihan mereka. UCAP: "Show the card. Tell us: This is my ___." → Siswa: "This is my mother. This is my sister." UCAP: "Everyone — thumbs up for your friend!" ⚡ jeda tenang singkat setelah presentasi terakhir: "Hands down. Take a breath. Sit nicely." 5 detik — sebelum masuk cek akhir.`,
          bantuan: 'Jika tidak ada yang mau maju: tunjuk dua siswa bersama — presentasi serentak.',
          cue    : '"Cards down." sebelum siswa sukarela maju — kartu di tangan = distraksi.',
          darurat: null,
          energi : '🔴',
        },
...
AKSI: Tunjuk ke siswa — beri jeda.
