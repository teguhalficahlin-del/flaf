  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tunggu semua duduk tenang. UCAP: "Good morning!" "Shapes are everywhere!" AKSI: Tunjuk papan tulis — gerakkan tangan membentuk persegi panjang di udara. UCAP: "Look — the board. Rectangle!" AKSI: Tunjuk jam dinding — gerakkan tangan membentuk lingkaran. UCAP: "The clock. Circle!" AKSI: Tunjuk pintu. UCAP: "The door — what shape?" "Show me with your hands!" → Siswa bentuk tangan → guru konfirmasi: "Yes — rectangle!"`,
          bantuan: null,
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tempel kartu di papan — dua batch. 👂 LISTEN FIRST — BATCH 1 UCAP: "Circle." [bentuk tangan bulat — pause 1 detik] "Square." [bentuk tangan kotak — pause 1 detik] "Triangle." [bentuk tangan segitiga — pause 1 detik] 🗣 TOGETHER → Siswa: "Circle! Square! Triangle!" UCAP: "Hands down. Look." [freeze mini 3 detik] 👂 LISTEN FIRST — BATCH 2 UCAP: "Rectangle." [bentuk tangan persegi panjang — pause 1 detik] "Star." [bentuk tangan bintang — pause 1 detik] "Heart." [bentuk tangan hati — pause 1 detik] 🗣 TOGETHER → Siswa: "Rectangle! Star! Heart!" 🗣 FULL 6 UCAP: "All together!" → Siswa: "Circle! Square! Triangle! Rectangle! Star! Heart!" 🔁 Putaran kedua: "Slow voice!"`,
          bantuan: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: Tepuk tangan sekali. → "Hands down. Eyes on me." UCAP: "Now — a guessing game!" [sambil bicara — gambar bentuk di udara sebagai gesture visual instruksi] "I draw slowly. You guess." "Hands up. Mouth closed." AKSI: Demo aturan: → Angkat tangan sambil tutup mulut → "Like this." AKSI: Demo permainan: → Gambar lingkaran perlahan → siswa angkat tangan diam → pilih siswa → siswa jawab. UCAP: "Ready?"`,
          bantuan: null,
        ...
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Open bag slowly." "One thing only." "No talking." "Close the bag." "Freeze. Bag down." [Tas harus ditutup dan diletakkan sebelum lanjut] AKSI: Guru demo dulu: "My eraser — rectangle!" UCAP: "What shape is it?" "Best shape — closest shape." [terima jawaban paling dekat untuk benda ambigu — jangan debat] → Siswa: "[Bentuk]!" [satu kata bentuk sudah cukup]`,
          bantuan: [
...

    {
      ...
      langkah: [
        ...
        {
          tipe   : 'instruksi',
          teks   : `AKSI: "Hands down. Quiet voice." Lambaikan tangan. UCAP: "Excellent! You know your shapes!" "Soft goodbye..." [guru ucap pelan → siswa ikut] "Goodbye, everyone! See you next time!" 🗣 TOGETHER → Siswa: "Goodbye, teacher! See you!"`,
