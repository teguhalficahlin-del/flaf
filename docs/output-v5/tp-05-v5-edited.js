...

    {
      ...
      langkah: [
        ...
        // L4 — INTI
        {
          ...
          cue    : 'Urutan latihan: red → blue → green → yellow → orange → purple → black → white. Pakai "Fast voice!" setelah red/blue/green/black. Tempo normal untuk yellow/orange/purple — bunyinya lebih sulit.',
          darurat: null,
          energi : '🟡',
        },
        ...
        // L5 — INTI
        {
          ...
          bantuan: null,
          cue    : '"Come back" dulu, baru "freeze" — urutan ini penting. Tunjuk lantai = sinyal kembali ke tempat. Pilih benda yang benar-benar dekat untuk demo — contohkan jarak pendek.',
        ...
        // L6 — INTI
        {
          ...
          bantuan: [
            'Jika berlari: beri dua tepukan tangan → "Walk!"',
        ...
        // L7 — INTI
        {
          ...
          bantuan: null,
          cue    : 'Diam 15 detik dulu untuk menenangkan — jangan terburu masuk pemberian contoh. Tas ditutup dan diletakkan sebelum tampil — fokus ke berbicara.',
          darurat: null,
          energi : '⚪',
        },
        ...
        // L8 — INTI
        {
          ...
          bantuan: [
            ...
            'Jika hanya sebut warna: angguk dan contohkan kalimat penuh — ucap\'This is my book. It is red.\' lalu isyarat ke siswa untuk mengulangi.',
          ],
...

    {
      ...
      langkah: [
        ...
        // L11 — PENUTUP
        {
          ...
          bantuan: null,
          cue    : 'Gerakan besar santai — tidak harus tunjuk semua kartu presisi. Lagu penutup = momen kebersamaan penutup, bukan akurasi latihan.',
          darurat: null,
          energi : '🟠',
        },
