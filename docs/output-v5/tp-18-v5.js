 ...
 * File: docs/output-v5/tp-18-v5.js
 * Format: v5.0
 * Source: docs/skenario/flaf-skenario-tp18-v2.txt
 * =============================================================
 */
  ...
  skenario: [

    {
      ...
      langkah: [
        ...
        // L1 — PEMBUKA · Set Tone Perayaan
        {
          tipe   : 'instruksi',
          teks   : `Guru berdiri di depan kelas — tenang, senyum lebar. UCAP: "Today — this is the LAST day of Phase A English." [Jeda 3 detik — biarkan kelas merasakan] UCAP pelan dan hangat, satu kalimat per napas: "Today is not a test. It is a celebration." "You may feel nervous. That is OK." "You may forget words. That is OK." "I will help you." [Stop — tidak perlu kalimat tambahan] [Pause — tunggu anggukan atau respons] UCAP: "Are you ready?" [Tunggu respons — lanjut]`,
        ...
        // L2 — PEMBUKA · Demo Template Poster
        {
          tipe   : 'instruksi',
          teks   : `Guru ambil satu template poster contoh — tunjuk ke kelas, hadap kelas. UCAP: "Look at this. This is the template. Four sections." → Tunjuk Section 1: "My name — write your name here." → Tunjuk Section 2: "My family — write about your family." → Tunjuk Section 3: "My house — write about your house." → Tunjuk Section 4: "My hobby — write about your hobby." UCAP: "Now — I show you what to say." Tunjuk papan — Hello! My name is ___. I have a ___ family. I live in a house. I like ___ because it is ___. → Guru model sambil tunjuk papan setiap kalimat: "Hello! My name is [nama guru]." "I have a big family." "I live in a house." "I like reading because it is fun!" "That is my world!" UCAP: "Simple. You know all these words. You learned them in Phase A."`,
          bantuan: null,
...

    {
      ...
      langkah: [
        ...
        // L3 — INTI · Pembuatan Poster
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Now — flip your poster. Face up." [Tunggu semua siswa balik poster — pastikan semua siap sebelum lanjut] UCAP: "Section 1 — write your name. Start now." [Timer 10 menit mulai] Guru circulate sepanjang pembuatan. Checkpoint menit ke-5: UCAP: "Check — Section 1 and 2 done? Good. Move to Section 3 and 4." Checkpoint menit ke-7: UCAP: "2 more minutes. Finish your favorite part." UCAP saat waktu habis: "Time! Posters face down. Look here."`,
          bantuan: [
            'Fast finisher: "Draw pictures! Make it beautiful!"',
            'Siswa stuck: dekati, bisik: "What is your hobby? Tell me." Guru scribe jika perlu.',
            'Siswa panik: "You are doing great. Take your time."',
            'Scribe support (menit ke-8, poster masih banyak kosong): guru scribe — siswa bicara, guru tulis.',
            'Poster kosong total / freeze: guru pegang poster bersama siswa, Q&A: "What is your name?" → tulis. "What do you like?" → tulis. Tidak perlu siswa menulis sendiri.',
            'Jika siswa belum selesai saat waktu habis: lanjut ke presentasi dengan poster yang ada — guru bantu lengkapi saat siswa maju.',
          ],
        ...
        // L4 — INTI · Demo Presentasi Guru
        {
          tipe   : 'instruksi',
          teks   : `Guru ambil poster contoh — berdiri di depan kelas. UCAP: "Watch me. I present first." → Guru pegang poster menghadap kelas. → "Hello! My name is [nama guru]." → "I have a big family." → "I live in a house." → "I like reading because it is fun!" → "That is my world! Thank you!" [Guru beri applause untuk diri sendiri — tunggu kelas ikut] UCAP: "See? Simple. 4–5 sentences. That is all." UCAP: "Now — before we start: when someone finishes, we do this." [tunjuk gesture thumbs up] "Thumbs up — means: I heard you. Well done." [Minta kelas latih thumbs up sekali] UCAP: "I will start from this side." [tunjuk baris atau deretan pertama] [Jika ada siswa spontan angkat tangan mau duluan → persilakan sebagai bonus]`,
          bantuan: null,
        ...
        // L5 — INTI · Sesi Presentasi
        {
          tipe   : 'instruksi',
          teks   : `UCAP ke penonton sebelum presenter pertama: "Posters on lap. Eyes front." Siswa presentasi satu per satu — dari tempat duduk atau maju ke depan, fleksibel. Setiap siswa: berdiri atau tetap duduk → pegang poster menghadap kelas → ucap 2–5 kalimat → selesai → guru: "Thank you!" → kelas thumbs up → guru langsung panggil nama berikutnya — tanpa jeda panjang. Batas ±20 detik per presenter — jika melewati ini, guru bantu akselerasi. Monitor energi kelas mulai dari presenter ke-6. Jika fokus mulai turun: UCAP: "Quick round — just your name and one hobby. Go!" Guru tidak koreksi grammar. Fokus pada courage dan attempt — bukan perfection.`,
          bantuan: [
            'Siswa gugup tapi mau coba: guru berdiri di samping, bisik kalimat pertama — "Hello, my name is…" Tunggu siswa lanjut.',
            'Siswa blank: Q&A singkat — "What is your name?" → "What do you like?" → guru announce: "This is [nama]. [Nama] likes drawing!" → thumbs up → lanjut. Tetap dihitung presentasi.',
...

    {
      ...
      langkah: [
        ...
        // L7 — PENUTUP · Celebration
        {
          tipe   : 'instruksi',
          teks   : `UCAP: "Now — stand up!" [Kelas berdiri] Ucap satu kalimat per napas, jeda setelah masing-masing: "You were brave." "You tried." "You spoke English." "That is AMAZING." UCAP: "Now — clap for yourself!" [Guru lead tepuk tangan dengan gesture jelas — tunggu kelas ikut penuh] UCAP: "And clap for your friends!" [Guru lead tepuk tangan lagi] [Setelah tepuk tangan kedua: guru angkat tangan ke atas — sinyal tangan turun] UCAP: "You finished Phase A. All of you. Together."`,
          bantuan: null,
        ...
        // L8 — PENUTUP · Closure Ritual
        {
          ...
          bantuan: null,
          cue    : 'Ritual ini wajib baris per baris — satu baris, tunggu kelas ulang, lanjut. Jeda 3 detik di akhir wajib — ini emotional closure, bukan transisi ke aktivitas berikutnya. Guru tidak tambahkan komentar apapun setelah jeda — biarkan momen itu selesai sendiri. Guru yang bicara lagi setelah jeda akan memecah closure.',
          darurat: null,
          energi : '🔵',
        },
