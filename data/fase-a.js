  ...
  tujuan_pembelajaran: [
    ...
    // ─── TP 2 — REVISI v3 ────────────────────────────────────────────────────
    {
      ...
      printables: [
        ...
        { file: 'tp02-introduce-girl.png', label: 'Hello I am (Perempuan)' },
      ],
      skenario: [
        {
          fase  : 'Pembuka',
    ...
    // ─── TP 3 ───────────────────────────────────────────────────────────────
    {
      ...
      printables: [
        ...
        { file: 'tp03-open-book.png',  label: 'Open Your Book' },
        { file: 'tp03-close-book.png', label: 'Close Your Book' },
  ...
  mode: {
    ...
    // ─── TP 5 ───────────────────────────────────────────────────────────────
    {
      ...
      printables: [
        ...
        { file: 'tp05-pink.png',   label: 'Pink (opsional)' },
      ],
      skenario: [
        {
          fase  : 'Pembuka',
  ...
  mode: {
    ...
    // TP 8 ────────────────────────────────────────────────────────────────────
    {
      ...
      printables: [
        ...
        { file: 'tp08-floor-plan.png', label: 'Denah Rumah' },
      ],
      skenario: [
        { fase: 'Pembuka', durasi: 10, langkah: [
  ...
  mode: {
    ...
    // TP 10 ───────────────────────────────────────────────────────────────────
    {
      ...
      printables: [
        ...
        { file: 'tp10-plate-worksheet.png',  label: 'Lembar Piring' },
      ],
      skenario: [
        { fase: 'Pembuka', durasi: 10, langkah: [
